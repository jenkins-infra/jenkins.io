...
. Join the link:/chat/[`#jenkins` and `#jenkins-hosting` IRC channel] and link:/chat/#cloaks[obtain a cloak].
...
The team has a dedicated `#jenkins-hosting` IRC channel on Freenode.
