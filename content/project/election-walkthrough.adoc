...
The message should include the name of the candidate and a brief description of their motivation to run for the board or officer position:
...
image::/project/election-walkthrough-screenshots/confirm-civs-account.png[Activate your CIVS account]
...
image::/project/election-walkthrough-screenshots/proceed-to-vote.png[Activate your CIVS account]
