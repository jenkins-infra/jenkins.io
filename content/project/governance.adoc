...
See the link:https://github.com/jenkinsci/jenkins/blob/master/MAINTAINERS.adoc[Jenkins Core maintainer guidelines] for more information about roles, their responsibilities and maintenance processes.
