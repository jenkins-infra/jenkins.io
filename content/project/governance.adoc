...
You need to apply for a link:../trademark-sublicense[sublicense] if you are using the term "Jenkins" as part of your own trademark or brand identifier for Jenkins-based software goods or services. It doesn’t matter if your trademark is unregistered, or if you do not plan to make any money using the mark.
...
A list of trademark usages approved by the project can be found on the link:../trademark-usage-approved[Approved Trademark Usage] page.
