...
Jenkins project uses link:https://wiki.jenkins-ci.org/display/JENKINS/Governance+Meeting+Agenda[biweekly project meetings] as the primary forum of decision making for matters that need consensus. The meeting is open to anyone, and the link:http://meetings.jenkins-ci.org/jenkins/[minutes are public]. Agenda items can be added by anyone by simply updating the Wiki page with your name.
