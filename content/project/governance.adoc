...
The Jenkins project uses biweekly project meetings as the primary forum of decision making for matters that need consensus. The meeting is link:/chat/#meeting[conducted on IRC] and open to anyone. Agenda items can be added by anyone by simply adding your topic to link:https://wiki.jenkins-ci.org/display/JENKINS/Governance+Meeting+Agenda[the Governance Meeting Agenda wiki page].
