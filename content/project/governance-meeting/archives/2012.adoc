...
https://github.com/freedomsponsors/freedomsponsors-jira-plugin/issues/4[omitted
for closed issues]?
(tonylampada)
...
[[GovernanceMeetingArchive2012-Feb22andMeeting]]
== Feb 22nd Meeting

WHEN
http://www.timeanddate.com/worldclock/fixedtime.html?msg=Jenkins+Governance+Meeting&iso=20120222T11&p1=224&ah=1&sort=1[February
...
WHEN
http://www.timeanddate.com/worldclock/fixedtime.html?msg=Jenkins+Governance+Meeting&iso=20120208T11&p1=224&ah=1&sort=1[February
...
JIRA) (fredg)
* Funding for giveaways in events (stickers and T-shirts)
