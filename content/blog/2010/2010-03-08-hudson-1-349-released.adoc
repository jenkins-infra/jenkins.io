...
* Fix deserialization problem with fields containing double underscore. (https://issue-redirect.jenkins.io/issue/5768[issue 5768])
* Fix deserialization problem for Exception objects where the XML has bad/old data. (https://issue-redirect.jenkins.io/issue/5769[issue 5769])
* Fix serialization problem with empty CopyOnWriteMap.Tree. (https://issue-redirect.jenkins.io/issue/5776[issue 5776])
...
* Added an extension point to annotate console output. (https://issue-redirect.jenkins.io/issue/2137[issue 2137])</ul>
