...
This release contains 63 commits, from six different contributors including our very own https://jenkins.io/content/keeping-your-configuration-and-data-subversion[Subversion-loving] https://twitter.com/MikeRooney[Mike Rooney] (mcrooney).
