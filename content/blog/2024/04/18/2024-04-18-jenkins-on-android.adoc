...
Select "Permanent Agent" as the mode, and for the description, I went with something like "The smartphone itself" because, why not?
...
And just for showing off, we'll also add a plugin that should detect we're running on Android, and add specific labels to the agent.
