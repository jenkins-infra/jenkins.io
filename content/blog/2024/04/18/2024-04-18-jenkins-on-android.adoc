...
We had installed link:https://wiki.termux.com/[Termux], link:https://www.openssh.com/[OpenSSH], and link:/blog/2023/03/30/android-and-jenkins/#installing-java-on-termux[Java] on the Android device, and checked that the agent link:/blog/2023/03/30/android-and-jenkins/#using-a-jenkins-ssh-agent[could be reached] from an adult-sized Jenkins controller.
