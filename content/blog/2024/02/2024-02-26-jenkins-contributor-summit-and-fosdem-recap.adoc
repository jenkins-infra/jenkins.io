...
image::/images/post-images/2024/02/26/contributor-summit-group-photo.jpg[Group photo of all the contributor summit attendees.,width=839,height=631,align=center]
