...
+
image:/images/post-images/2024/9_Most_Innovative_DevOps_Open_Source_Project.png[DevOps Dozen Most Innovative DevOps Open Source Project award., role=center]
