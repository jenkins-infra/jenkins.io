...
Today's post involves a proposal originally from community member https://github.com/jglick[Jesse Glick] who has proposed in *https://issue-redirect.jenkins.io/issue/29068[JENKINS-29068]* that https://groovy-lang.org[Groovy] be split out from the "core" Jenkins distribution. The linked issue expands on what the problem is here:
