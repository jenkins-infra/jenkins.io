...
One of these fixes, SECURITY-95, results in possible problems in plugins such as *Maven Plugin*, *Javadoc Plugin*, and *HTML Publisher Plugin*, so make sure to https://www.jenkins.io/doc/book/system-administration/security/configuring-content-security-policy[read all about that in the documentation].
