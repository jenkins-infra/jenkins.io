...
Day two and onward saw me and other Jenkins org admins manning the Ask the Expert booth for the Jenkins community.
...
There were a range of questions from JenkinsX to many of the plugins I maintain such and the Jenkins Prometheus and the
...
First up was the awesome Mark Waite to talk about the Git plugin. A lot of people use git in Jenkins and it is because
of this man. Thank you so much for all that you do Mark.
...
We closed out the day and the event with a picture of some of the Jenkins org admins and Google Summer of Code student.
...
This was an amazing experience. Huge thanks to Cloudbees, the Jenkins community, Google Summer of Code, Tracy Miranda, Alyssa Tong and my employer
Sysdig.
