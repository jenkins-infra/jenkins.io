...
I'll add a `choice` parameter with the list of platforms and add conditions to `when` directive that will either let all platforms execute or only execute cells that match my selected platform. 
