...
After years of internal usage we decided to share this service with the community and we are pleased to introduce **a new free service available to every Jenkins user**: **https://www.cloudbees.com/jenkins-health-advisor?utm_medium=blog&utm_source=jenkins.io&utm_campaign=cloudbees-jenkins-advisor-plugin[Jenkins Health Advisor by CloudBees]**.
