...
Since 2017, I started to do some contributions to the Jenkins community. As a beginner, the translation work might be
...
I really appreciate https://github.com/daniel-beck[Daniel Beck] helps me to add localization support,
https://github.com/bitwiseman[Liam Newman] helps me to review JEP-216, and many other community members.
