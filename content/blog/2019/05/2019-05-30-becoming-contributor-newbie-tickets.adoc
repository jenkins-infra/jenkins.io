...
- newcomer
author: romenrg
description: "In this second article on becoming a Jenkins contributor, the complete process of fixing a newbie-friendly
issue (in Jenkins core) is described in detail; from reviewing guidelines and tickets, to submitting the PR and having
the change released (in a new Jenkins version)"
opengraph:
