...
During this October event everyone can support open-source by contributing changes, and then earn a limited edition swag.
And we invite you to contribute to Jenkins, regardless of your experience and background.
You can write code, improve documentation and design, localize Jenkins or create new artwork.
Any pull requests in GitHub counts!
...
link:https://jenkins.io/participate/[contribute] to Jenkins.
...
You are welcome contribute to **any** repository in **any** of these organizations,
...
If you wonder about link:https://jenkins-x.io[Jenkins X], it also participates in Hacktoberfest this year!
