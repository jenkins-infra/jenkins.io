...
image:/images/post-images/2019-dwjw-email-san-fran-rev.png[2019 dwjw email san fran, role=center, float=left, height=256]
...
=== Thinking about Jenkins Security - link:https://github.com/MarkEWaite[Mark Waite]
