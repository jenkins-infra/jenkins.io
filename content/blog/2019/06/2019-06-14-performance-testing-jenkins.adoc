...
`configuration-as-code` plugin, as shown above.
...
or by passing the JSON benchmark Reports to link:https://jmh.morethan.io[JMH visualizer]. As an example, here is
a report of some benchmarks from the Role Strategy Plugin visulized using JMH visualizer.
