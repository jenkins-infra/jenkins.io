...
+
image:/images/post-images/2019/06/2019-06-28-multibranch-pipeline-support-for-gitlab/gitlab-section.png[gitlab-section]
+
. Select `Add GitLab Server` | Select `GitLab Server`

. Now you will now see the GitLab Server Configuration options.
+
image:/images/post-images/2019/06/2019-06-28-multibranch-pipeline-support-for-gitlab/gitlab-server.png[gitlab-server]
+
...
.. Select `Add`
+
image:/images/post-images/2019/06/2019-06-28-multibranch-pipeline-support-for-gitlab/gitlab-credentials.png[gitlab-credentials]
+
. Testing connection:
...
(36 characters).
+
image:/images/post-images/2019/06/2019-06-28-multibranch-pipeline-support-for-gitlab/gitlab-token-creator.png[gitlab-token-creator]
