...
We are thrilled to announce **full support for Java 11 in Jenkins**.
...
Beyond these events, Core and Plugins maintainers have worked hard to make sure they discover and solve as many issues as possible related to Java 11 support.
