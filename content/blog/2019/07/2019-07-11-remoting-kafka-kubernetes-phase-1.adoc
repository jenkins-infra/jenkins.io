...
* Implement Cloud API to provision Remoting Kafka Agent. (link:https://issue-redirect.jenkins.io/issue/57668[JENKINS-57668])

* Integrate Cloud API implementation with Helm chart. (link:https://issue-redirect.jenkins.io/issue/58288[JENKINS-58288])

* Unit tests and integration tests.

* Release version 2.0 and address feedbacks. (link:https://issue-redirect.jenkins.io/issue/58289[JENKINS-58289])
