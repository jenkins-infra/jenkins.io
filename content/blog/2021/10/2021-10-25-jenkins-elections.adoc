...
* link:/participate/translate/[Translate] Jenkins software or other materials
...
* link:/participate/review/[Review] changes to code or documentation that are submitted by others
* link:/participate/donate/[Donate] funds to help the project
...
The list of candidates for each position will be announved November 7, 2021.

== Who Nominates a Candidate?

Anyone may propse a nomination.
