...
When the new certificate is installed on March 22, 2021, Jenkins versions older than 2.178 (April 2018), won’t be able to communicate with the update center.
