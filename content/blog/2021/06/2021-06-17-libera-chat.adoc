...
* `#jenkins` - general discussion channel for Jenkins users and developers.
  We do not longer consider it a central chat for all things Jenkins, but we intend to keep it available to users
...
We do not longer manage or control our channels.
 ...
 * IRC User Passwords.
   ...
   We strongly advice all users to rotate their passwords if they were used on Freenode IRC.
   
 In the coming weeks we will publish backups of IRC channel conversations somewhere in our GitHub repositories.
 If you need any conversations right now, please reach out to the Jenkins Infrastructure team.
...
As always, we will appreciate any suggestions and feedback!
