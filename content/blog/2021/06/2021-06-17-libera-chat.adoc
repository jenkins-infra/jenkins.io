...
* `#jenkins-release`- Chat used for Jenkins core release coordination by the link:https://github.com/jenkinsci/jenkins/blob/master/MAINTAINERS.adoc#team[Release Team]
