...
In May we also organized a https://www.jenkins.io/events/online-hackfest/2020-uiux/[Jenkins UI/UX hackfest] where we worked on some key stories improving user experience.
...
including https://www.jenkins.io/blog/2020/11/04/codeql/[GitHub CodeQL evaluation] for targeted security issues search
 and https://www.jenkins.io/blog/2020/03/02/findsecbugs/[Find-Sec-Bugs adoption] for static analysis of the plugin and Jenkins core code.
...
This year’s student, https://www.jenkins.io/blog/authors/zaycodes[Zainab Abubakar],
...
See the project report by Zainab https://www.jenkins.io/blog/2020/12/04/gsod-project-report/[here].
...
See more information about terminology updates https://cd.foundation/blog/2020/08/25/jenkins-terminology-changes/[here] and https://www.jenkins.io/blog/2020/06/18/terminology-update/[here].
...
Over the year, the team published 54 user stories and six case studies on https://jenkinsistheway.io/[https://jenkinsistheway.io/] as well as a significant amount of community marketing.
...
See all the stories https://jenkinsistheway.io/[HERE]
...
Read more: https://www.jenkins.io/blog/2020/12/22/gsoc-report/[https://www.jenkins.io/blog/2020/12/22/gsoc-report/] 
...
We also encouraged contributors to participate in the Documentation as Code and terminology cleanup across the entire Jenkins ecosystem. https://www.jenkins.io/events/hacktoberfest/[https://www.jenkins.io/events/hacktoberfest/] 
...
And a special congratulations is in order to this year’s https://www.jenkins.io/blog/2020/12/11/devops-world-2020-jenkins-contributors-awarded-top-honors-at-devops-worlds-2020/[Jenkins Contributor Award ]winners:
...
* We introduced a new https://www.jenkins.io/project/roadmap/[public roadmap] for the Jenkins project.
...
* A new https://www.jenkins.io/project/adopters[list of Jenkins adopters] was introduced on jenkins.io.
This list highlights Jenkins users and references their case studies and success stories,
including ones submitted through the https://www.jenkins.io/blog/2020/04/30/jenkins-is-the-way/[Jenkins Is The Way] portal.
...
* https://www.jenkins.io/project/conduct/[Jenkins Code of Conduct was updated] to the new version of Contributor Covenant.
In particular, it sets best practices of behavior in the community, and expands definitions of unacceptable behavior.

More information can be found https://cd.foundation/announcement/2020/08/04/cd-foundation-announces-jenkins-graduation/[HERE], and https://www.jenkins.io/blog/2020/08/04/cdf-graduation/[HERE].

== Public Roadmap

The Jenkins project now has a public, community-driven https://www.jenkins.io/project/roadmap/[project roadmap].  Roadmap items are major initiatives and are considered as official plans. 
...
user interface improvements, https://www.jenkins.io/blog/2020/05/25/read-only-jenkins-announcement/[read-only configuration pages],
and Google Summer of Code projects like the GitHub Checks API or External Fingerprint Storage.  

Other roadmap items include mirror infrastructure improvements, a new https://www.jenkins.io/blog/2020/08/12/windows-installers-upgrade/[Windows installer],
...
* https://github.com/halkeye[Gavin Mogan] and https://github.com/markyjackson-taulia[Marky Jackson] joined the https://www.jenkins.io/project/governance/#governance-board[Jenkins Governance Board]
* https://github.com/timja[Tim Jacomb] was elected as https://www.jenkins.io/project/team-leads/#release[Release Officer]
* https://github.com/markyjackson-taulia[Marky Jackson] became the new https://www.jenkins.io/project/team-leads/#events[Events Officer]
* Olivier Vernin, Daniel Beck, and Mark Waite will continue as Infrastructure, Security and Documentation officers

Full election results: https://www.jenkins.io/blog/2020/12/03/election-results/[https://www.jenkins.io/blog/2020/12/03/election-results/] 
...
There are many areas on the https://www.jenkins.io/project/roadmap/[roadmap]: UX revamp, cloud native Jenkins, pluggable storage, etc.
There will also be a continued cleanup of old dependencies and technical debt.
Several key changes are expected to land in the March LTS baseline: update to Spring Security, XStream unforking, JQuery update, etc.(https://www.jenkins.io/blog/2020/11/10/major-changes-in-weekly-releases/[announcement]).
...
At the moment we are looking for Google Summer of Code 2020 mentors and project ideas (https://www.jenkins.io/blog/2020/12/16/call-for-mentors/[announcement]).
We are also ready to consider other non-coding project ideas as a part of CommunityBridge If you are interested, please contact the https://www.jenkins.io/sigs/advocacy-and-outreach/[Advocacy and Outreach SIG].
...
Join us in the https://www.jenkins.io/mailing-lists/[mailing lists] and https://www.jenkins.io/sigs/[special interest groups],
