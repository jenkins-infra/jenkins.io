...
The plugin will read the commit messages from the latest tag till the latest commit and determine what would be the next semantic Version for that particular project.
