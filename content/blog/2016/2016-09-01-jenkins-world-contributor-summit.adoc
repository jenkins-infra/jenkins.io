...
another link:http://www.meetup.com/jenkinsmeetup/events/232811529/[Contributor
...
attendance to present details on their design, requirements, and tentative
...
* Updates from the various project
  link:https://wiki.jenkins-ci.org/display/JENKINS/Team+Leads[officers].
...
previous Summits to be immensely useful for sharing my own thoughts but also
hearing new perspectives from the others in attendance.

Our space is limited however! I encourage you to join us, so please
link:http://www.meetup.com/jenkinsmeetup/events/232811529/[RSVP soon]!
