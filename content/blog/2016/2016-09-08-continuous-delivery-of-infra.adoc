...
slwoly but surely, introducing more and more code to define the Jenkins
project's infrastructure. Whether implemented in our
...
The more things that are _code_, the more we can apply continuous delivery
practices to consistently and reliably build, test and deliver our
infrastructure.
...
code. Whether we're sanity-checking our BIND zone files:
...
infrastructure to get the most out of our limited time.
