...
link:https://wiki.jenkins.io/display/JENKINS/Pipeline+Model+Definition+Plugin[_Pipeline-Model-Defintion_]
...
. Install the lastest version of the
 link:https://wiki.jenkins.io/display/JENKINS/Pipeline+Model+Definition+Plugin[_Pipeline-Model-Defintion_] plugin.
