...
// TODO: Image of trend graph from JUnit similar to

// TODO: Image of testReport showing failed case(s) with console output.
...
TODO: Image showing report with occasional failing test and job
...
TODO: Image showing intermittent test failures but job remains in passing state.
