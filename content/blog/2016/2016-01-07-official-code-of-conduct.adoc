...
link:/conduct[Code of Conduct] for the Jenkins project (meeting minutes
...
link:/conduct[adapted the covenant] to meet the unique needs of a multifaceted
...
* The link:/conduct#code-of-conduct[code of conduct] itself
* link:/conduct#reporting[Instructions on how to report problems]
* link:/conduct#handling-of-violations[An outline of how violations will be handled]
