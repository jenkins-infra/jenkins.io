...
who works at link:http://puppet.com[Puppet] and created the
link:https://plugins.jenkins.io/puppet-enterprise-pipeline[Puppet Enterprise Pipeline plugin].
====


During PuppetConf 2016, myself and Brian Dawson from CloudBees announced the
link:https://plugins.jenkins.io/puppet-enterprise-pipeline[Puppet Enterprise
