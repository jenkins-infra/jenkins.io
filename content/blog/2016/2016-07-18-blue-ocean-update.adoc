...
state by publishing the plugin to the experimental update centre.

We are happy to announce that Blue Ocean alpha is now available and we
looking at publishing new builds daily.
...
https://www.google.com/url?q=https://jenkins.io/blog/2013/09/23/experimental-plugins-update-center/&sa=D&ust=1468882625495000&usg=AFQjCNG4oBaJQUFbNkv7p_fhZnd_hnqrCw[activate
