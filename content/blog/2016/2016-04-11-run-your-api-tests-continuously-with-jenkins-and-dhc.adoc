...
Well known for his contribution to the link:https://www.groovy-lang.org/[Apache Groovy] project,
...
using the link:https://groovy-lang.org[Apache Groovy] programming language, it's
