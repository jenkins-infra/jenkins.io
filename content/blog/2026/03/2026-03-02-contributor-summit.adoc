...
If you missed the blog post about the Bug Bounty program, you can find it here: link:/blog/2025/12/10/jenkins-bug-bounty-program-yeswehack-european-commission/[Announcing the new Jenkins Bug Bounty Program].
