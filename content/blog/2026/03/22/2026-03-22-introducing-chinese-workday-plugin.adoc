...
The link:https://plugins.jenkins.io/chinese-workday/[Chinese Workday Plugin] was created to support that use case in Jenkins.
...
- Plugin site: link:https://plugins.jenkins.io/chinese-workday/[plugins.jenkins.io/chinese-workday]
- Source code: link:https://github.com/jenkinsci/chinese-workday-plugin[github.com/jenkinsci/chinese-workday-plugin]
