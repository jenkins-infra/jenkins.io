---
layout: post
title: Java JVM Updates and Memory Improvements at Jenkins
tags:
- jvm
- update
- memory
...
If you are currently running Jenkins on Java 17, it is worth to evaluating, and anyhow needed for the latest LTS Update to upgrade to Java 21.
