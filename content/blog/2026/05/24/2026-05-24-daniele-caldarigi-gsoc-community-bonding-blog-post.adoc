...
Hello everyone,
I'm Daniele, an Italian computer science student, and this summer I'll be working on the link:/projects/gsoc/2026/projects/ai-chatbot-to-guide-user-workflow/[AI ​​Chatbot to Guide User Workflow] plugin during the GSoC 2026.
...
to understand the functionality of a complex software like Jenkins. My goal is to create a plugin that's useful for Jenkins beginners, but can also
