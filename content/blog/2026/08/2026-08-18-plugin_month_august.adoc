...
If dark mode isn't your style, but you are bored with the standard Jenkins look, don't worry!
The Jenkins UI extension ecosystem offers a variety of alternative themes to refresh your dashboard.

Check out the link:https://plugins.jenkins.io/ui/search/?labels=theme[Jenkins Theme Plugins Index] to explore all available options.

For instance, if you want soothing pastel palettes instead of stark high contrast, the community has shown great interest in the link:https://plugins.jenkins.io/catppuccin-theme/[Catppuccin Theme Plugin].
