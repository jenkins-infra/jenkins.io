...
I have built link:https://github.com/jenkinsci/jenkinsfilelint[jenkinsfilelint] to catch these problems early — right at commit time, before the code ever reaches the CI.
...
The project has now been accepted and moved under the link:https://github.com/jenkinsci[jenkinsci] GitHub organization. Feedback from Jenkins users and Pipeline authors is still very welcome.

== Try It

The project is open source under the MIT license. Contributions, bug reports, and feature requests are welcome at link:https://github.com/jenkinsci/jenkinsfilelint[github.com/jenkinsci/jenkinsfilelint].
