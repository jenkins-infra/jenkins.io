...
<div class="app-post-page__carousel app-post-page__carousel__full_width">
  <img src="/images/post-images/2026/06/jenkinsfilelint-demo.gif" alt="jenkinsfilelint demo" />
</div>
++++
...
If the file passes validation on this endpoint, it will pass on the server as well.
