...
The link:https://www.jenkins.io/blog/2022/03/25/systemd-migration/[end result] of the migration provides unification of service management implementation, and better integration between Jenkins core and service management framework.
...
** This allows users the opportunity to work directly with Jenkins developers and maintainers on the ever evolving platform.
This provides the Jenkins community another avenue to make their voices heard and influence Jenkins' future.
