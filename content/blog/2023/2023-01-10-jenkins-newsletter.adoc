...
The Pipeline Steps reference guide has been improved. The updates include search functionality, overall appearance, and a reduction in page load.
...
* Ci.jenkins.io:
** Windows 2022 generally available
** JDK19 available for developer (faster testing, "edge" experiments)
* Migration of repo.jenkins-ci.org (Jfrog sponsored) to their new AWS platform: improved performances for artifact downloads
* Download mirrors (get.jenkins.io):
** Added a new download mirror in Asia: Thanks to Servana!
** Decommissioned a mirror in the Netherlands: mirror.gruenehoelle.nl. Thanks for the service!
* Infrastructure costs: Cleanup of Azure resource led to $1,000 of monthly savings
