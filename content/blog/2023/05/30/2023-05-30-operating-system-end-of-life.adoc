...
Our link:/doc/book/platform-information/support-policy-linux/[Linux support policy] states that the Jenkins project does not support, test, or accept pull requests for operating systems that are no longer supported by their provider.
