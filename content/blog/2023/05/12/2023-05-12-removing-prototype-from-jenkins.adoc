...
When an attempt was made to upgrade to 1.7.3 in 2018 in https://issue-redirect.jenkins.io/issue/49319[JENKINS-49319], the change had to be reverted.

Clearly the status quo is unsustainable.
For these reasons, we have been working to remove Prototype from the Jenkins ecosystem in https://issue-redirect.jenkins.io/issue/70906[JENKINS-70906].
