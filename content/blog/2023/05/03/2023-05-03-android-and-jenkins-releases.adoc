...
** defaults to `0.1` (10%).
* `updatePriority`: Sets the update priority for a new release. Refer to link:https://developer.android.com/guide/playcore/in-app-updates[Google's documentation] for more information.
