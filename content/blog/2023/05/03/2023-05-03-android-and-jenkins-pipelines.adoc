...
Then you will have to link:https://cloud.google.com/iam/docs/service-accounts-create[create a service account] and link:https://cloud.google.com/iam/docs/keys-create-delete[key].

We’ll have to create an environment variable within Jenkins…. For that, we first have to install the link:https://plugins.jenkins.io/envinject/[Environment Injector plugin].
