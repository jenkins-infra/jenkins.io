...
Congratulations to all link:https://summerofcode.withgoogle.com/programs/2023/organizations[172 accepted open source participating organizations]!
...
For detailed information on Jenkins GSoC 2022, see link:/projects/gsoc/2022/[completed projects].
...
and to prepare their project proposals before the deadline on April 4th.
...
The application period starts on March 20th, but you should prepare now!
