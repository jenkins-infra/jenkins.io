...
- gounthar
opengraph:
  image: /images/post-images/2023/06/12/2023-06-12-remove-outdated-plugins-while-using-docker/opengraph.png
discourse: true
---
...
image::/images/post-images/2023/06/12/2023-06-12-remove-outdated-plugins-while-using-docker/the-following-plugins-are-deprecated.png[width=839,deprecated plugins warning]
...
image::/images/post-images/2023/06/12/2023-06-12-remove-outdated-plugins-while-using-docker/the-following-plugins-are-deprecated-once-more.png[width=839,deprecated plugins warning once again]
...
image::/images/post-images/2023/06/12/2023-06-12-remove-outdated-plugins-while-using-docker/popper-can-t-be-uninstalled.png[width=839,search for the deprecated plugin]
...
image::/images/post-images/2023/06/12/2023-06-12-remove-outdated-plugins-while-using-docker/who-is-my-daddy.png[what is the parent plugin blocking the uninstallation?]
...
image::/images/post-images/2023/06/12/2023-06-12-remove-outdated-plugins-while-using-docker/bootstrap4-can-be-uninstalled.png[width=839,search for the parent plugin]
...
image::/images/post-images/2023/06/12/2023-06-12-remove-outdated-plugins-while-using-docker/remove-the-plugin-binary.png[width=839,remove the plugin binary]
...
image::/images/post-images/2023/06/12/2023-06-12-remove-outdated-plugins-while-using-docker/popper-can-be-uninstalled.png[width=839,popper can be uninstalled now]
...
image::/images/post-images/2023/06/12/2023-06-12-remove-outdated-plugins-while-using-docker/pending-uninstallation.png[width=839,pending uninstallation]
