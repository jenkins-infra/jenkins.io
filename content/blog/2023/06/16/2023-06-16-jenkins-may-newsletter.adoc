...
* Prototype.js removal from Jenkins core and Jenkins plugins.
  ...
  Detailed issue reports are available in the link:https://issues.jenkins.io/browse/JENKINS-70906[Jira epic].
...
We particularly thank the usability and accessibility team at Deutsche Telekom IT GmbH for their issue:JENKINS-71153[accessibility assessment report].
