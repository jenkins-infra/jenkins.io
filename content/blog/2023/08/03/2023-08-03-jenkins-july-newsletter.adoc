...
** link:/security/advisory/2023-06-14/[https://jenkins.io/security/advisory/2023-07-12/]
** Multiple high-score vulnerabilities
** A total of 16 plugins were affected
* Jenkins core and plugins security advisory July 26
** link:/security/advisory/2023-07-26/[https://jenkins.io/security/advisory/2023-07-26/]
...
* Jira upgrade was successful. Special thanks to the Linux Foundation
* Mark Waite elected to the link:https://cd.foundation/about/governing-board/[CDF Governing Board] as a committer representative
* Jenkins core continues to improve
** Prototype.js removal is progressing well. More details are in the link:https://docs.google.com/spreadsheets/d/1dpaKALZaK0_HIGy6ony3wnegr1frTg3u1lngG4KdoC8/edit?usp=sharing[tracking sheet].
Thanks to author:basil[Basil Crow], author:timja[Tim Jacomb], and many others
* Jenkins plugins continue to improve
** HTMLUnit 3 upgrades are in progress. More details are in the link:https://docs.google.com/spreadsheets/d/1ih_gVd9uhxLw4BZ6IeJGrYsvu-DvIF0xovu4wZbaXy8/edit#gid=0[tracking sheet].
...
* Production outage on public services (download mirrors, LDAP, etc.) which led to a public IP change -
More details in the link:/blog/2023/07/12/jenkins-mirrors-postmortem-outage/[Post Mortem blog post].
...
* Windows 2022 agents general availability.
...
* Browser confirm dialog has been replaced with friendly modal dialogs - link:https://github.com/mawinter69[Markus Winter]
* Safe restart has a better user experience - link:https://github.com/meiswjn[Jan Meiswinkel]
* Log manager page has more improvements - author:janfaracik[Jan Faracik]
...
*** The documentation and usage areas are being updated to reflect this change, while also clarifying that Java 11 support in Jenkins will continue, and this transition aims to help users upgrade and migrate effectively while enjoying the benefits of Java 17.
...
Thanks to all the participants for these insights and work!
...
A blog post highlighting and providing background for the transition will be available on the Jenkins Community blog.
...
If you missed it, see link:/blog/2023/07/22/gsoc-2023-midterm/[HERE] for the recap.
...
image:/images/post-images/2023/08/03/2023-06-20-jenkins-may-newsletter/image1.png[image,width=839]
