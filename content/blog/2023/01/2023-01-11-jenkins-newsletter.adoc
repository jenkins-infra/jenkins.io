...
We have to deal with even more CVEs with fancy name such as link:/blog/2022/03/31/spring-rce-CVE-2022-22965/[CVE-2022-22965] to analyze and understand but which didn't affected Jenkins.
