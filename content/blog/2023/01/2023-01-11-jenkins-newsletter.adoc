...
Jenkins was also able to expand by adding new release leads thanks to our release officer, author:timja[Tim Jacomb].

* Newer members and contributors to Jenkins are taking on the role of LTS release lead
