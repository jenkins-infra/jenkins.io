...
He has been an active contributor in the Jenkins project since 2007, mostly in the acceptance test harness and the static code analysis suite (which is now replaced by the plugin:warnings-ng[Warnings Next Generation Plugin]).
...
We recognize and thank author:halkeye[Gavin Mogan] for his work on site search and on the site:https://plugins.jenkins.io[plugins site].
...
* link:/blog/2022/04/11/She-Code-Africa-contributhon/[She Code Africa Contributhon]
