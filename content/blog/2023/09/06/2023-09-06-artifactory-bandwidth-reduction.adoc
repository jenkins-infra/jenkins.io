...
We're delighted that they continue to sponsor the Jenkins project and continue to provide our aritfact hosting service, link:https://repo.jenkins-ci.org[repo.jenkins-ci.org].
