...
Note that seen the increasing popularity of Hacktoberfest and to ensure that it can be sustained for another decade, 
link:https://hacktoberfest.com/about/#digital-rewards[the organization is moving away from a free t-shirt reward to a digital reward].
...
- In previous years Hacktoberfest sponsors have given participants who completed 4 PR/MRs the option to plant a tree through our partner Tree Nation instead of redeeming a t-shirt. 
