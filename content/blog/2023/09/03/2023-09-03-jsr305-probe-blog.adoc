...
This blog post describes the latest addition to the plugin health scoring system developed as part of link:../../../../projects/gsoc/2023/projects/add-probes-to-plugin-health-score.adoc[my Google summer of Code Project]: a probe that detects usages of the `JSR-305` framework in plugins.
