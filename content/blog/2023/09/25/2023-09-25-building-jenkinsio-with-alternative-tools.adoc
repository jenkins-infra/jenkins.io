...
Another drawback of Awestruct is that it is greatly under maintained in the last two years and people from jenkins-infra are currently maintaining it.
...
You can watch me talk about the project in the link:https://youtu.be/W4eSVCTmqb8?t=1841[Midterm Presentation here].
...
- Some pages like Changelogs, Pipeline step reference in documentation still need more refining and are missing some features that exist on the current documentation pages.
