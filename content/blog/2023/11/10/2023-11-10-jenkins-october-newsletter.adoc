...
** link:/security/advisory/2023-10-18/[link:/security/advisory/2023-10-18/]
** Includes essentially the Jetty update that provided multiple fixes
* Plugin security advisory published on October 25
** link:/security/advisory/2023-10-25/[link:/security/advisory/2023-10-25/]
...
** More information in the https://issues.jenkins.io/browse/JENKINS-60865[related ticket].
...
The link:/blog/2023/10/31/marc-s-napkin-upgrade-guide/[guide to update Jenkins], from new author Marc Phillips, provides instructions on how to update Jenkins and what his process looks like.
