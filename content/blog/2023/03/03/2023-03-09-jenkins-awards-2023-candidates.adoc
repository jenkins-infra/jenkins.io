...
You can view the award guidelines, definitions, and previous winners on the link:link:link:https://github.com/cdfoundation/foundation/blob/main/CDF%20Awards%20Guidelines.md[CD Foundation awards] page.
