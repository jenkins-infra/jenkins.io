...
- oleg_nenashev
description: >
  This article announces the 2020 elections and describes the next steps for contributors.
opengraph:
  image: TODO
---

Nominations for the 2020 elections open for one governing board position and five officer positions, namely:
Security, Events, Release, Infrastructure and Documentation.
...
You sign-up can sign up for voting in two ways:
...
and the board welcomes additional nominations beyond who we might consider.
...
* link:/project/board[Jenkins Governance Board] and link:https://wiki.jenkins.io/display/JENKINS/Team+Leads[Jenkins Officers]
