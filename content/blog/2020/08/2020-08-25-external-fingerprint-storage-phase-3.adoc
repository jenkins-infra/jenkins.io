...
Project] comes to an end, and as we finish off, we release one more fingerprint storage plugin:
...
As an example, the link:[Docker Traceability Plugin] stores information like the name of Docker images inside these
facets.
