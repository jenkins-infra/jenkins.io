...
Being at the end of GSoC 2020, we had to finish all the implementation works and testing before a stable release in the main repository. Throughout this program, there were lots of learning and hard work will make this plugin valuable to the Data Science and Jenkins community.
...
An interesting feature which allows users to connect to their existing language kernels more than connecting to only IPython kernel was introduced in this phase. It can be selected in multiple steps with different kernel.
Images and graphs produced by Jupyter notebooks will be saved in user preferred folder in the workspace that can be used for reporting/analytic purposes later. Hoping this blog concises about Machine Learning Plugin's features and future contributions. Thank you for your interest and support !!!
...
- Save visual artifacts according to the step name
- Support for Windows and Linux

Future improvements

- Improving performance of the plugin
- Try to implement link:https://issues.jenkins-ci.org/browse/JENKINS-63377[JENKINS-63377]
