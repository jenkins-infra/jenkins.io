...
Also, a link:https://cd.foundation/ambassador-program-overview-application/[Community Ambassador]
...
Through CDF we have got access to the link:https://jenkins.devstats.cd.foundation/[DevStats service] service which provides statistics about the community contributions and helps us to track trends and discover areas for improvement.
On the marketing side, foundation organizes webinars, podcasts and newsletters.
...
**In 2018** we started introducing link:/sigs[special interest groups] which focused on the community areas.
...
and to address them.
We reviewed the project processes and to compare them with the Graduated Project criteria defined in the link:https://github.com/cdfoundation/toc/blob/master/PROJECT_LIFECYCLE.md[CDF project lifecycle].
Based on this review, we have made changes in our processes and documentation.
...
and at the same time helps potential contributors to find out the hot areas and opportunities for contribution.
...
* A new link:/project/adopters[list of Jenkins adopters] was introduced on jenkins.io.
  This list highlights Jenkins users and refers their case studies and success stories,
  including ones submitted through the link:/blog/2020/04/30/jenkins-is-the-way/[Jenkins Is The Way] portal.
  Please do not hesitate to add your companies there!

Community::

* We passed the link:https://www.coreinfrastructure.org/[Core Infrastructure Initiative (CII)] certification.
  This certification helped us to verify compliance with open source best practices,
  ...
  See the Jenkins core's page link:https://bestpractices.coreinfrastructure.org/en/projects/3538[here].
...
* The default link:https://github.com/jenkinsci/.github/blob/master/CONTRIBUTING.md[Jenkins contributing template] was updated to cover more common cases for plugin contributors.
  This page contributes to the link:/participate[Participate and Contribute] guidelines hosted on our website,
...
* The Jenkins Core link:https://github.com/jenkinsci/jenkins/blob/master/docs/MAINTAINERS.adoc[maintainer guide] was updated to include maintenance and issues triage guidelines.
  It should help us to deliver quality releases and to timely triage and address issues reported by the Jenkins users.
...
please contacts us in the Jenkins community channels (link:/mailing-lists[mailing lists], link:/chat[chats])!
