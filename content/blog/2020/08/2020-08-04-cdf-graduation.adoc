...
* The Jenkins Core link:https://github.com/jenkinsci/jenkins/blob/master/MAINTAINERS.adoc[maintainer guide] was updated to include maintenance and issues triage guidelines.
