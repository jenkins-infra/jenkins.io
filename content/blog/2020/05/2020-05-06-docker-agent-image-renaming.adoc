...
* link:https://hub.docker.com/repository/docker/jenkins/ssh-agent[jenkins/ssh-agent] is the new name of the old link:https://hub.docker.com/repository/docker/jenkins/ssh-slave[jenkins/ssh-slave] image,
