...
This is one of the Jenkins project in GSoC 2020. We are working this new link:https://www.jenkins.io/projects/gsoc/2020/projects/machine-learning/[Machine Learning Plugin] for this GSoC 2020.
