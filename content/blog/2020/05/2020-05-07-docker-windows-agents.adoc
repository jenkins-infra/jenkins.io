...
You will then be able to connect this agent using the link:plugins.jenkins.io/ssh-slaves/[SSH Build Agents plugin] as "jenkins" with the matching private key.
