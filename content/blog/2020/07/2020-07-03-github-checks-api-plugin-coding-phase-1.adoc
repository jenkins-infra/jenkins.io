...
Our work on supporting GitHub Checks API are mostly done by now, so after the releasing, Jenkins developers can then create GitHub checks for a GitHub branch source project by consuming our API.
