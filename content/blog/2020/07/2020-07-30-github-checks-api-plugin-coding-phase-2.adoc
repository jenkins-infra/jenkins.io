...
Lastly, it is exciting to inform that we are currently making the checks feature available on link:https://ci.jenkins.io[ci.jenkins.io] for hosted plugins, please see link:https://issues.jenkins-ci.org/browse/INFRA-2694[INFRA-2694] for more.
