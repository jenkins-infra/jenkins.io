---
layout: post
title: Windows Support policy and windows service changes in Jenkins 2.248
tags:
- announcement
- windows
- platform
...
and what new features Jenkins users get with this release and how to upgrade.
...
This release also upgrades link:https://github.com/winsw/winsw[Windows Service Wrapper] from 2.3.0 to 2.9.0 and replaces the bundled binary from .NET Framework 2.0 to 4.0.
...
* Prompt for permission elevation when administrative access is required.
  Now Jenkins users do need to run the agent process as Administrator to install the agent as a service from GUI. 
...
barring we have enough resources and CI Infrastructure contributors.
Any contributions and feedback will be appreciated!

We also keep working on improving Windows Services.
During his Google Summer of Code 2020 project,
link:/blog/authors/buddhikac96[Buddhika Chathuranga] is working on adding support for YAML Configurations in Windows Service Wrapper,
