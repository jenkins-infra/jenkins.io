...
Please refer to the link:https://issue-redirect.jenkins.io/issue/62754[Jira Epic] for this phase.
...
* link:https://github.com/jenkinsci/redis-fingerprint-storage-plugin[Redis Fingerprint Storage Plugin]
* link:https://issue-redirect.jenkins.io/issue/62754[Issue Tracker for Phase 2]
* jep:226[]
