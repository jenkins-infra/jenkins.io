...
* link:/blog/2019/06/21/performance-testing-jenkins/[Micro-benchmarking Framework for Jenkins Plugins]
* link:/blog/2019/08/16/folder-auth-plugin/[Folder authorization plugin blog post]
...
* link:https://github.com/jenkinsci/working-hours-plugin[Working Hours Plugin]link:https://github.com/jenkinsci/react-plugin-template[Template for Jenkins plugins with React UI]
...
* link:/blog/2019/08/19/remoting-kafka-kubernetes-release-2/[Blog post for release 2 of the plugin]
