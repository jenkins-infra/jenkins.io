...
The most active month was October 2019 when reached the record high number of contributions: **915** unique contributors, **124** of them were first-timers, thanks to link:/hacktoberfest/[Hacktoberfest]!.
...
We also deployed **4** new services, migrated **7** services from to Azure Kubernetes Service and updated many other services.
More changes to happen in next months, and we are looking for link:/projects/infrastructure/#team[new INFRA team members]!
