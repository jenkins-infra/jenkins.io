...
At DevOps World on September 24, 2020 the Jenkins project announced the winners of the Jenkins Contributor Awards.  The Jenkins Contributor Awards honor those who have made significant contributions to the Jenkins project.  The 2020 Jenkins Contributor Award winners are:
