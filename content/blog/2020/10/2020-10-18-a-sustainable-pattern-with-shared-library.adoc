...
I construct a build plan as early as possible. Taking decisions on what till be done in this build. So that the rest of the code becomes more streamlined.
