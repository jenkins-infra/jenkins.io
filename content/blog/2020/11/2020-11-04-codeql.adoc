...
Sign up now by https://issues.jenkins-ci.org/browse/INFRA[filing an INFRA issue] in the `github` component and list the plugin repositories you'd like to have scanned.
