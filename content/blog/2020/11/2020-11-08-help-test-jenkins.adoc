...
Recently we have link:https://groups.google.com/g/jenkinsci-dev/c/AWOPeU4k0DI[selected Jenkins 2.263 as a new baseline] for the link:/download/lts/[LTS release line], with ETA in December 2021.
