...
description: This blogpost summarizes Google Summer of Code 
---
...
The projects delivered new highly anticipated new features and/or key architecture changes
...
Please refer to the project pages for more information and links to the blogposts and project demos.
...
Also, thanks a lot to all mentors who were guiding students during their projects: **TODO**

//TODO: Add a list of mentors
...
and we also recommended project teams to hold their own retrospective meetings.
...
Overall, we have got a very positive feedback from students and mentors.
The GSoC framework in Jenkins has matured a lot during the previous years,
and we have invested a lot in creating guidelines and recommendations for all parties.
This year these guidelines helped a lot because all the expectations were known in advance.
As usual, there is a lot to improve, especially with regards to the community bonding phases and cross-project communications.
...
We submitted our application, and we got accepted.
...
Many maintainers work alone, and it is not the best place.
...
So far it works really well, and GSoC excels among outreach programs with these regards.

// TODO:Move more notes from the draft
...
We also thank Continuous Deliver
...
== So, what about GSoC 2021?

Yes, we are interested to participate in Google Summer of Code 2021.
The application period for organizations will start only in a few months,
but we have already started preparing to the next GSoC session.
...
and to come up with a good proposal.
