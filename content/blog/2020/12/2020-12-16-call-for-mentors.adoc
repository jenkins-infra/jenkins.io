...
Students work on the project full-time for three months (June to August).
Prior to the full-time coding phase, there is a month of community bonding, to welcome students to the Jenkins community and acquaint them with the projects processes for communication and collaboration.
