...
Externalizing fingerprint storage is a Jenkins project in GSoC 2020.
...
Once the plugin has been installed, you can configure the Redis server details by following the following steps:
