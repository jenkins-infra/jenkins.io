...
Also, you can communicate with us in the WinSW Gitter channel, which is a great way to get in touch and there is project sync up meetings every Tuesday at 13:30 UTC on the Gitter channel. 
