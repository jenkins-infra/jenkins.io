...
> Documentation is not glamorous, but is is goodness.
> -- Thomas Otter, https://www.otteradvisory.com/2020/01/documentation-and-safety/
...
image:/images/post-images/2020-06-08-docs-from-hackfest/sample-pages.png[Sample Hackfest documentation pages, width="80%"]
...
Join the https://gitter.im/jenkinsci/docs[documentation chat channel] for personalized help and encouragement.
...
You can find Jenkins project ideas and more information here.
