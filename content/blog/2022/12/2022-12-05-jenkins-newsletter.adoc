...
* ssh-agent docker image is now using https://github.com/jenkinsci/docker-ssh-agent/commit/9abba2cf2b286ad35bdb0df634c3e471da373478[correct volume] for agent workspace
...
== User Experience Update [Mark Waite]
...
== Documentation Update [Kevin Martens]
