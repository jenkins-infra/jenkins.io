...
Create a pull-request with your idea in a .adoc file in the link:https://github.com/jenkins-infra/jenkins.io/tree/main/content/projects/gsoc/2022/project-ideas[project ideas].
