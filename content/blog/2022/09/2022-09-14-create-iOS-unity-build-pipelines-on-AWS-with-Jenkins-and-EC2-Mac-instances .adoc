...
_Sergey Kurson, Solutions Architect, AWS_

_Glenn Duncan, Proserve Specialist, AWS_
...
[cols=",",options="header",]
|===
|image:/images/post-images/2022-09-14-Create-iOS-Unity-build-pipelines/image12.jpeg[image,width=128,height=128] a|
_Sergey Kurson_

_As a passionate gamer and 10+ years IT professional I keep looking for
modern and efficient approaches to solving IT challenges. (TBU)_

|image:/images/post-images/2022-09-14-Create-iOS-Unity-build-pipelines/image13.jpeg[Profile photo for Glenn
Duncan,width=128,height=128] a|
_Glenn Duncan_

_I have been a Professional Services Consultant for 2 years, and I enjoy
helping people build effective and efficient solutions._
