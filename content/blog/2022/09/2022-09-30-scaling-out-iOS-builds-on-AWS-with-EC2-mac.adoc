...
Sudhir Reddy Maddulapally, sr. specialist solutions architect, AWS EC2
...
image:/images/post-images/2022-09-30-scaling-out-iOS-builds-on-AWS-with-EC2-mac/image1.jpeg[image,width=622,height=194]
...
image:/images/post-images/2022-09-30-scaling-out-iOS-builds-on-AWS-with-EC2-mac/image2.jpeg[image,width=625,height=272]
...
We will be speaking more on this topic at the Jenkins Contributor
Summit, on September 27, 2022 at DevOps World in Orlando, Florida. Hope
to see you there!

== Suggested Tags:

Amazon EC2 Mac, Jenkins, iOS builds, baremetal, type-2 virtualization,
CloudBees, macOS, AWS
