...
:sig: infra
opengraph:
  image: /images/post-images/2022-04-DigitalOcean-sponsors-Jenkins.png
---

image::/images/post-images/2022-04-DigitalOcean-sponsors-Jenkins.png[DigitalOcean sponsors the Jenkins project]
...
The donation has allowed us to run jobs from link:https://ci.jenkins.io[ci.jenkins.io] on DigitalOcean.
