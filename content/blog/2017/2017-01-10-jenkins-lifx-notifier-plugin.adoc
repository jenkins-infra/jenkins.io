...
link:https://plugins.jenkins.io/lifx-notifier[LIFX notifier plugin]
and a
...
The existing Existing link:https://plugins.jenkins.io/lifx-notifier[LIFX notifier plugin]
...
* Leanr how to subscribe to Jenkins job state changes using appropriate
  extension points.
...
Check out the link:https://plugins.jenkins.io/lifx-notifier[LIFX notifier page]
