...
This Pipeline works quiet well, except it doesn't print anything at the start of
...
accessible to multiple stages, this doesn't mean that it can't be done.
...
``
For this series, I chose to stick to using features that are supported
