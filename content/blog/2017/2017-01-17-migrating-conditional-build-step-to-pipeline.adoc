---
layout: post
title: "Migrating Conditional BuildSteps to Pipeline"
tags:
- pipeline
- freestyle
- plugins
...
With all the new developments in Jenkins Pipeline (and Declarative Pipeline
on the horizon), it's easy forget what we did to create "pipelines" before
