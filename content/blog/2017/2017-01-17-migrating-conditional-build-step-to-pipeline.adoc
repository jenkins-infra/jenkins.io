---
layout: post
title: "Refactoring Conditional BuildSteps into Jenkins Pipeline"
tags:
- pipeline
- freestyle
- plugins
...
With all the new developments in Jenkins Pipeline (and
...
*link:https://jenkins.io/doc/book/pipeline/[Pipeline]*.
...
In this post, we'll take a look at how we might migrate Freestyle jobs with
Conditional BuildSteps to Jenkins Pipeline.
Unlike Freestyle jobs, implementing conditional behavior in Jenkins Pipeline is trivial,
but migrating jobs using complex conditional build steps will require a bit more care.


== Graphical Programming

The Conditional BuildStep plugin lets users add conditional logic to Freestyle
jobs from within the Jenkin web UI.  It does this by:
...
image::/images/post-images/2017-01-17/freestyle-conditional-param.png[Freestyle Job Parameters, role="center", width=800]

image::/images/post-images/2017-01-17/freestyle-conditional-config.png[Freestyle Job Conditional BuildStep, role="center", width=800]
...
Jenkin Pipeline, on the other hand, enables users to implement a pipeline as code.
...
image::/images/post-images/2017-01-17/freestyle-conditional-long-full.png[Longer Freestyle Job, role="center", width=800]
