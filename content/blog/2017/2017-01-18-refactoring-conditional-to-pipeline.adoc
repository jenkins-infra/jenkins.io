...
image::/images/post-images/2017-01-18/freestyle-conditional-param.png[Freestyle Job Parameters, role="center", width=800]

image::/images/post-images/2017-01-18/freestyle-conditional-config.png[Freestyle Job Conditional BuildStep, role="center", width=800]
...
Jenkin Pipeline, on the other hand, enables users to implement their pipeline as code.
...
image::/images/post-images/2017-01-18/freestyle-conditional-long-full.png[Longer Freestyle Job, role="center", width=800]
