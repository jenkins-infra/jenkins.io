...
write link:https://github.com/jenkins-infra/jenkins.io/blob/main/CONTRIBUTING.adoc#adding-a-blog-post[blogposts]
* Automate Tests
...
(link:https://github.com/jenkins-infra/jenkins.io/blob/main/CONTRIBUTING.adoc[contributing])
* Packaging (
