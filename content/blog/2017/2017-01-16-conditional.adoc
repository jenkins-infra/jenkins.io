...
In this post, we'll take a first look at how Freestyle jobs using the
Conditional BuildStep plugin might be migrated to Jenkins Pipeline.
Implementing conditional behavior in Jenkins Pipeline is trivial,
...
image::/images/post-images/2017-01-16/freestyle-conditional-param.png[Freestyle Job Parameters, role="center", width=800]

image::/images/post-images/2017-01-16/freestyle-conditional-config.png[Freestyle Job Conditional BuildStep, role="center", width=800]
...
image::/images/post-images/2017-01-16/freestyle-conditional-long-full.png[Longer Freestyle Job, role="center", width=800]
