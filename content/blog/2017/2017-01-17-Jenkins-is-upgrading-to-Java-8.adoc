...
Back in link:/blog/2016/11/22/what-jvm-versions-are-running-jenkins-the-return/[last November, we discussed interesting statistics showing that Jenkins was now running Java 8 on a majority of its running instances].
