...
IMPORTANT: The Jenkins Bug Bounty Program has concluded.
No reports can be submitted through the YesWeHack platform anymore.
We would like to thank all security researchers who participated and contributed to improving the security of Jenkins.
Please submit future reports through the standard Jenkins security reporting channels as described link:/security/reporting/[here].
