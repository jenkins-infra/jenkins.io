...
- Sign up to mentor link:https://www.jenkins.io/projects/gsoc/2026/project-ideas/[one of these project ideas] or propose your own.
...
If you don’t have a specific project idea, consider being a mentor for one of link:https://www.jenkins.io/projects/gsoc/2026/project-ideas/[these project ideas].
...
Refer to the link:https://www.jenkins.io/projects/gsoc/proposing-project-ideas/[instructions] for submitting ideas, which include an `.adoc` template and examples.

== Need more inspiration?

A great example is the link:https://www.jenkins.io/blog/2023/10/25/what-is-the-plugin-health-score/[Plugin Health Score].
