...
This effort culminated in a major cleanup of the codebase, with over _85,000 lines of code removed_
...
The goal is to lower the barrier to entry for contributors, not raise it. Jenkins has hundreds of contributors around the 
