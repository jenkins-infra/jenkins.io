...
My project involves link:/projects/gsoc/2025/projects/improving-tekton-client-plugin/[modernizing the Jenkins Tekton Plugin] to create a stable, production-ready integration between Jenkins and Kubernetes-native Tekton pipelines.
...
For those interested in the technical details of our testing strategy and modernization approach, the presentation recording is available on the link:/projects/gsoc/#gsoc-2025[Jenkins in Google Summer of Code page].
