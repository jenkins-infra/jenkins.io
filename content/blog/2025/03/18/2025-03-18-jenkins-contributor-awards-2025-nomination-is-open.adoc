...
Once voting opens, make your voice heard by voting through the official link:https://forms.gle/TjFR6kgYoasrUrFF9[Google form], which include all award categories and nominees.
