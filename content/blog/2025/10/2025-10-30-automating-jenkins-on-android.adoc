...
- gounthar
opengraph:
  image: /images/post-images/2025/10/30/automating-jenkins-on-android/jenkins-android-automation.png
discourse: true
description: >
...
image:/images/post-images/2025/10/30/automating-jenkins-on-android/jenkins-android-automation.png[Jenkins on Android automation]
