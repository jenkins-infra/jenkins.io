...
I decided that to work on link:https://jenkins.io/projects/gsoc/gsoc2018-project-ideas/#simple-pull-request-job-plugin[Simple Pull-Request Job Plugin] project.
