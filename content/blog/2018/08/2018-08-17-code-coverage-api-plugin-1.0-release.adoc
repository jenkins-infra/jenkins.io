...
==== Failed Conditions and Flexible Threshold Setting
You can set different failed conditions and thresholds to control build result.
...
=== Future Tasks
* Support more coverage tools (https://issue-redirect.jenkins.io/issue/52467[JENKINS-52467], https://issue-redirect.jenkins.io/issue/52469[JENKINS-52469] and etc.)
