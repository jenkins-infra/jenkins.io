...
To learn about the other methods and get hands-on practice, join me at DevOps World/Jenkins World in San Francisco or Nice for the workshop “Continuous Delivery and Containerization – Leveraging Jenkins 2 and Docker”.
