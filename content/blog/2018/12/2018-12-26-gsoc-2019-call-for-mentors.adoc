...
and create a short description of your project idea 
2. Make the document publicly open for comments
3. Let us know about the project idea via link:https://gitter.im/jenkinsci/gsoc-sig[our gitter channel] or the 
link:https://groups.google.com/forum/#!forum/jenkinsci-gsoc-all-public[mailing list].
4. After the initial feedback, share your idea with other contributors who might be interested 
