...
at the Google office in Mountain View on Oct 12, 13 and 14, 2018.
...
of an link:https://issues.jenkins-ci.org/browse/JENKINS-54059[Epic] capturing the action items.
...
The summit started by a welcoming diner at the Google Cafeteria and an evening session
...
On thing to say is that everyone at the conference had heard of or already uses Jenkins.
...
The first one was that Google is thinking of creating a program called "Season of Docs" (GSoD for short),
...
You can see the slides of his lightning talk here:
...
[NOTE]
====
We have notes for all the session in link:https://docs.google.com/document/d/1tN9fnnJw9aBYsDwfDOVL5URTyoOyS3UYH4ijMAUOl3A/edit#[this document].
Some sessions were captured in separated documents which are linked from the main document (or from here).
====

There were lots of good ideas in those sessions, and we will do what we can next year to implement some of them.

Some organizations have said that the key for students retention
...
network with mentors of other organizations, and enjoy late evening snacks, music and the chocolate table!

== Sunday Oct 14

On Sunday, the sessions continued. An interesting session was "Beyond GSoC, What can Google do?".
One person got a big round of applause when he said: "Cloud credits". It turns out the GSoC Organizers
have been trying to get that for us for about 3 years. Google may be big and powerful, but somethings
...
long commitment. This was noted by the GSoC admins.
