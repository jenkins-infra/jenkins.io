...
| Contribute to Jenkins core and plugins to enable Java 11 in future releases.
  ...
  link:https://issues.jenkins-ci.org/issues/?jql=project%20%3D%20JENKINS%20AND%20status%20in%20(Open%2C%20%22In%20Progress%22%2C%20Reopened)%20AND%20labels%20%3D%20newbie-friendly%20AND%20labels%20%3D%20java11[newbie-friendly issues]
