...
. What was done in coding Phase 1
...
# location of reports. (Only xml reports are supported).
# These reports will get published after the build
reports:
...
* link:https://www.youtube.com/watch?v=qWHM8S0fzUw[Phase 2 Presentation video](July 12, 2018)
* link:https://docs.google.com/presentation/d/1V3hHEHHkJlwI3sK1VTIDOvbflXMtdn_JUc9cOFIrOOQ/edit?usp=sharing[Phase 2 Presentation Slides](July 12, 2018)
