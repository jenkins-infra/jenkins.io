...
.. Support for webhooks (link:https://issue-redirect.jenkins.io/issue/51941[JENKINS-51941])
.. Check if trusted people have approved a pull request and start build accordingly (link:https://issue-redirect.jenkins.io/issue/52517[JENKINS-52517])
. Finalize documentation (link:https://issue-redirect.jenkins.io/issue/52518[JENKINS-52518])
. Release 1.0 (link:https://issue-redirect.jenkins.io/issue/52519[JENKINS-52519])
. Plugin overview blog post

=== Coding Phase 3 plans after release

. Support the “when” Declarative Pipeline directive (link:https://issue-redirect.jenkins.io/issue/52520[JENKINS-52520])
. Nice2have: Support hierarchical report types (link:https://issue-redirect.jenkins.io/issue/52521[JENKINS-52521])
. Add unit tests, JenkinsRule tests, and ATH tests (link:https://issue-redirect.jenkins.io/issue/52495[JENKINS-52495], link:https://issue-redirect.jenkins.io/issue/52496[JENKINS-52496])
. Automatic Workspace Cleanup when PR is closed (link:https://issue-redirect.jenkins.io/issue/51897[JENKINS-51897])
. Refactor snippet generator to extensions (link:https://issue-redirect.jenkins.io/issue/52491[JENKINS-52491])


https://issue-redirect.jenkins.io/issue/52452[Phase 3 Jira Epic]
