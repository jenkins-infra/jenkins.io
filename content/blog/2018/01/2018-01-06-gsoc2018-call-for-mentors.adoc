...
It is fine to propose project ideas till March 12 when the student application phase begins.
We kindly ask that you to do it before Jan 17, 2017 so that we can add it to the application materials.
