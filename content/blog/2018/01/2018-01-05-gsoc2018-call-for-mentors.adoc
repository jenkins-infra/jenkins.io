...
This year we are interested to participate in
...
If you are interested to propose a project or to join an existing one, respond to
link:https://groups.google.com/forum/#!topic/jenkinsci-dev/We-14-z_YXU[this thread]
in the Jenkins Developer mailing list.
We kindly ask to do it before *Jan 17, 2017*.
