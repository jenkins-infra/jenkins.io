...
** Integrate Cobertura Plugin with Code Coverage API https://issue-redirect.jenkins.io/issue/51424[(JENKINS-51424)].
** Provide API for getting coverage information. E.g. summary information about coverage (percentages, trends) https://issue-redirect.jenkins.io/issue/51422[(JENKINS-51422)], https://issue-redirect.jenkins.io/issue/51423[(JENKINS-51423)].
* Implementing abstract layer for other report formats like JSON. https://issue-redirect.jenkins.io/issue/51732[(JENKINS-51732)].
* Supporting converters for non-Java languages. https://issue-redirect.jenkins.io/issue/51924[(JENKINS-51924)].
...
* Adding source code navigation in Coverage Result Page https://issue-redirect.jenkins.io/issue/51988[(JENKINS-51988)].
