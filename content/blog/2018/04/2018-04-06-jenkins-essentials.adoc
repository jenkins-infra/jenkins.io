...
but in post I wanted to expand ab it on <<what, what>> Jenkins Essentials is, and our
...
with
link:https://github.com/jenkinsci/jep/blob/master/jep/302[JEP-303]
...
link:https://github.com/jenkins-infra/evergreen[jenkins-infra/everreen]
...
or our
link:https://issues.jenkins-ci.org/secure/RapidBoard.jspa?rapidView=406[Jira issues board].
