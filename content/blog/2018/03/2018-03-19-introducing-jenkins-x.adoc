...
Here's demonstration of the above features of Jenkins X running on GKE:
...
So I hope the above has given you a feel for the vision of where we are heading with Jenkins X and to show where we are today. The project is still very early and we have https://github.com/jenkins-x/jx/issues[lots to do]! We're also working on high level [roadmap]
