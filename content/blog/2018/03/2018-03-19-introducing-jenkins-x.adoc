...
If you really don't want to use the public cloud, you can http://jenkins-x.io/getting-started/install-on-cluster/[install Jenkins X on an existing kubernetes cluster] (if it has RBAC enabled!). If you can [install and run minikube](https://github.com/kubernetes/minikube) then you should be able to http://jenkins-x.io/getting-started/create-cluster/[install Jenkins X on it].
