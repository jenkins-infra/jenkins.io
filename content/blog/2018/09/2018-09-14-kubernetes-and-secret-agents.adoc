...
You can also inject your configuration data by entering raw yaml, as you can see at the bottom of the first screenshot.
...
There are a wealth of resources available on running Jenkins on Kubernetes, and I hope this blog post help to further that knowledge.
Even better, come to
