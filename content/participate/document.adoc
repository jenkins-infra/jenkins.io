...
* https://issues.jenkins-ci.org/issues/?filter=18650&jql=project%20%3D%20WEBSITE%20and%20component%20%3D%20content%20or%20labels%20in%20(documentation%2C%20docs-sig)%20and%20status%20in%20(Open%2C%20Reopened%2C%20"To%20Do")[More advanced documentation tasks] (no `newbie-friendly` label set)
