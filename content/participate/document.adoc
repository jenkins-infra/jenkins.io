...
* link:https://github.com/jenkins-infra/jenkins.io/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22[More advanced documentation tasks] (no `newbie-friendly` label set)
