...
Events we organize::
Our events include link:/projects/jam[Jenkins Area Meetup], link:/projects/jam[Jenkins Area Meetup],  link:https://www.meetup.com/pro/cicd-cdf/[Continuous Delivery Foundation CI/CD Meetups], and
