...
For Jenkins itself, the link:/changelog-stable/[long term support changelog], the link:/doc/upgrade-guide/[upgrade guide], and the link:/changelog/[weekly changelog] is http://jenkins-ci.org/changelog[here].
