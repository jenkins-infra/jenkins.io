...
plugin page.
** After clicking the link if you end up on JIRA, follow the instructions on link:https:/#reporting-issue-in-jira[Reporting Issue in JIRA]
** After clicking the link if you end up on Github, follow the instructions on link:https:/#reporting-issue-in-github[Reporting Issue on Github]
