...
* link:https://issue-redirect.jenkins.io/issue/73542[AWS Lambda]
* link:https://issue-redirect.jenkins.io/issue/73543[SLOCCount]
...
There are other plugins, all under 700 installs, that have issues created for them in the Jenkins issue tracker, linked to the overall link:https://issue-redirect.jenkins.io/issue/73539[YUI removal epic].
