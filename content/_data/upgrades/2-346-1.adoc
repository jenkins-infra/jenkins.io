...
The link:https://plugins.jenkins.io/versioncolumn/[version node monitors] plugin displays the remoting version of the connected agent in the "Nodes" page.
The plugin can be configured to require matching remoting versions, matching Java versions, and more.
