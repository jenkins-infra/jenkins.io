...
Jenkins controller images with the following tags will use Java 11 beginning with 2.302.1:

* `jenkins/jenkins:lts`
* `jenkins/jenkins:lts-alpine`
* `jenkins/jenkins:lts-centos7`
* `jenkins/jenkins:lts-slim`
* `jenkins/jenkins:2.302.1`
* `jenkins/jenkins:2.302.1-alpine`
* `jenkins/jenkins:2.302.1-centos7`
* `jenkins/jenkins:2.302.1-slim`
...
* `jenkins/jenkins:2.302.1-jdk8`
* `jenkins/jenkins:2.302.1-alpine-jdk8`
* `jenkins/jenkins:2.302.1-centos7-jdk8`
* `jenkins/jenkins:2.302.1-slim-jdk8`
...
* 2.302.1-lts is replaced with 2.302.1
* 2.302.1-lts-alpine is replaced with 2.302.1-alpine
* 2.302.1-lts-centos7 is replaced with 2.302.1-centos7
* 2.302.1-lts-slim is replaced with 2.302.1-slim
