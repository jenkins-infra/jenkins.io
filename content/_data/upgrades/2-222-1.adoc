...
// TODO insert many links in the inline description from the PR upgrade guide
...
// TODO Link to https://github.com/jenkinsci/jenkins/pull/4330 

The resource file `jenkins-slave.xml` has been removed as it's been unused in Jenkins core since 2017.
WMI Windows Agents Plugin needs to be updated to version 1.3.1 or newer (released in March 2017).
