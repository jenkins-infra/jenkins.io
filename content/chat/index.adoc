...
#jenkins is not only a registered channel, but the Jenkins project has an official relationship with Freenode (see http://freenode.net/group_registration.shtml[the Freenode site] for more details).
