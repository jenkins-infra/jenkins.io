...
This special interest group focuses on improving Jenkins Pipelines, as well as the experience one receives in the process of authoring a Jenkins Pipeline.
