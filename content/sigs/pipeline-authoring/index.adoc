...
Meeting are held weekly on Friday, event can be found on the link:https://jenkins.io/event-calendar/[community calendar]
Links to the SIG meetings are announced in the Gitter channel prior to each meeting.

Meeting notes for the SIG are posted in this
link:https://docs.google.com/document/d/1EhWoBplGl4M8bHz0uuP-iOynPGuONjcz4enQm8sDyUE/edit#[Google Document].

++++
<iframe src="https://docs.google.com/document/d/1EhWoBplGl4M8bHz0uuP-iOynPGuONjcz4enQm8sDyUE/edit#?embedded=true" width="100%" height="600px"></iframe>
++++
