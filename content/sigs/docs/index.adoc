...
As of March 2024, we have more than 1,000 plugins which already use GitHub as a documentation source, but there are still hundreds of plugins to migrate.
