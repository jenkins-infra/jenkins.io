...
* jira:JENKINS-59467[Template issue for plugin documentation migration to GitHub] (newbie-friendly)
...
The Documentation SIG meets in office hours each Monday at *23:00 UTC* and each Thursday at *18:00 UTC*.
