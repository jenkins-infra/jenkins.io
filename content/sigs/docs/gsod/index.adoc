...
** For example, this page is written in Asciidoc.
   You can find its sources link:https://github.com/jenkins-infra/jenkins.io/blob/main/content/sigs/docs/gsod/index.adoc[here].
...
In such cases we document usage of these tools in link:https://github.com/jenkins-infra/jenkins.io/blob/main/CONTRIBUTING.adoc[our contributing guidelines] and help newcomer maintainers if needed.
