...
| Currently we are link:link:/doc/developer/publishing/wiki-page/#migrating-from-wiki-to-github[migrating our plugin documentation] from Jenkins Wiki to GitHub,
