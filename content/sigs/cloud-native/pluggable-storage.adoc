...
| **Test Results** + 
  **(Preview)**
| API is available in preview since plugin:junit[JUnit Plugin 1.35].
  Remaining changes are tracked as link:https://github.com/jenkinsci/junit-plugin/issues/142[junit #142]
| https://plugins.jenkins.io/junit-sql-storage/[Junit SQL Storage]
...
* A SQL implementation is available for preview in https://plugins.jenkins.io/junit-sql-storage/[Junit SQL Storage] plugin.
