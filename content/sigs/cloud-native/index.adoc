...
links:
  link:https://github.com/jenkinsci/sig-cloud-native/blob/main/meetings.md[Cloud Native SIG repo where we keep all meeting notes and documents]
...
Meeting agenda and notes are available link:https://github.com/jenkinsci/sig-cloud-native/blob/main/meetings.md[here].
We keep notes on HackMD.io, where everyone can add new topics to the agenda for upcoming meetings or take notes during the meetings.
Please edit the meeting notes on HackMD.

We hold regular SIG meetings scheduled weekly on link:https://www.jenkins.io/events/[Friday at 12 PM UTC.]
