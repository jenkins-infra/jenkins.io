...
Meeting agenda and notes are kept on link:https://hackmd.io/7uB6FuEqQAOp_-blPGykzA[HackMD.io] where everyone can add new topics to the agenda for upcoming meetings or take notes during the meetings.
Please click edit button to edit the document.
