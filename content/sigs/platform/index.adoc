...
** link:/doc/book/platform-information/support-policy-servlet-containers/[Servlet container support policy]
...
See the link:/project/roadmap[Jenkins Project roadmap] for other project details.
...
In our SIG we plan to support the two most recent long term support versions of Java.
The link:/doc/book/platform-information/support-policy-java/[Java support policy] has more details.
...
* Support for virtual machines like link:https://www.graalvm.org/[GraalVM] or link:https://quarkus.io/[Quarkus], including native executable packaging

=== Windows support

Many Jenkins users run controller or agents on Windows.
We support modern Windows versions and provide an official installer for Windows.

Scope of interest:

* link:/doc/book/platform-information/support-policy-windows/[Windows support policy]
* Native Windows installers (MSI)
...
We have regular meetings on Tuesday every four weeks, at *15:00 UTC*.
