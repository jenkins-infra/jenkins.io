...
=== Slack Channel
The UX SIG uses Slack as the main way to discuss any relevant topics. The channel used for this is #jenkins-ux-sig on the CDF Slack group. You can join the Slack channel via:
