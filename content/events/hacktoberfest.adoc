...
a| `stable/jenkins` helm chart was recently been moved to link:https://github.com/jenkinsci/helm-charts[jenkinsci/helm-charts].
  ...
  There are many smaller and bigger task which could be tackled. Every contribution counts. Here are some ideas:

  * Remove offensive terms
  * Use WebSockets to connect agents
  * Improve it's documentation
  * Use jenkins-plugin-cli to download plugins
  * Remove helm.sh/chart labels or introduce an option to remove them to have fewer changes when using GitOps

link:https://github.com/jenkinsci/helm-charts/milestone/1[v3.0.0 release]link:https://github.com/jenkinsci/helm-charts/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22[good first issues], 
link:https://github.com/jenkinsci/helm-charts/issues?q=is%3Aissue+is%3Aopen+label%3Adocumentation[documentation]
