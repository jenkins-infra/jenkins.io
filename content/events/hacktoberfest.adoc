...
//TODO: fix the discourse link (see also header) as soon as available
...
** If a repository has no `hacktoberfest` topic set, contact the maintainers to see if they are willing to accecpt such contribution.


//TODO: add Discourse link
