...
// image:/images/hacktoberfest/logo-hacktoberfest-horizontal.svg[Hacktoberfest, role=center]
...
You can work on code or documentation, contribute to link:https://wiki.jenkins.io/display/JENKINS/Internationalization[localization], or create new link:/artwork[artwork], etc.
...
** For your pull or merge requests to be accepted, your pull or merge requests must be merged, or have the `hacktoberfest-accepted` label, or have an overall approving review on either GitHub or GitLab.
...
* link:https://github.com/search?q=org%3Ajenkinsci+org%3Ajenkins-infra+org%3Ajenkins-zh+topic%3Ahacktoberfest[List of repositories marked for Hacktoberfest] - you can just submit pull requests, no extra steps needed.
