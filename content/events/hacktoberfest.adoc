...
| French translation (maybe others languages)
| Git, French, optional: Java developement tools to run Jenkins or plugins from sources locally.
a| Improve coverage of French localization of Jenkins.
  ...
  * Use and improve if needed the localization end user facing documentation.
  * Use and improve if needed link:https://www.jenkins.io/doc/developer/internationalization/[the localization documentation]
