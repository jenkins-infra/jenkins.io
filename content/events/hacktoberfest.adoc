...
opengraph:
  image: /images/hacktoberfest/hacktoberfest_2025_social_600x300.png
---
...
You can also share your experiences with Jenkins by link:https://github.com/jenkins-infra/jenkins.io/blob/main/CONTRIBUTING.adoc#adding-a-blog-post[creating a new blogpost].
...
| Create new images and logos for link:/projects/jam/[Jenkins area meetups],
  ...
  link:https://github.com/jenkins-infra/jenkins.io/blob/main/CONTRIBUTING.adoc#adding-a-logo[Adding a logo]
...
The same is possible for other languages, let us know if you are interested!
  ...
  * Some proposals are listed in a link:https://issue-redirect.jenkins.io/issue/66660[dedicated Epic].
...
See our link:/events/hacktoberfest/event-kit.adoc[Event Kit] for more information and guidelines.
...
* link:/blog/2024/09/2024-09-30-hacktoberfest.adoc/[2024]
