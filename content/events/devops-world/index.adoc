...
links:
  ...
  # discourse: 
opengraph:
  image: /images/conferences/devops-world-2022.png
description: >
...
image:/images/conferences/devops-world-2022.png[DevOps World 2022, role=center, link="https://www.devopsworld.com/"]
