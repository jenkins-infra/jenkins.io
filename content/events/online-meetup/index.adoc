...
Our link:https://www.meetup.com/jenkins-online-meetup/[meetup.com page] and Zoom account are sponsored by the link:https://cd.foundation/[Continuous Delivery Foundation (CDF)].
