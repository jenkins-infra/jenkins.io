...
This is not something new, this topic was discussed multiple times at contributor summits and finally led to the creation of the Jenkins UX SIG which currently coordinates the Look&Feel improvements in Jenkins.
...
The event happens on the last week of the community bonding, and hence it would give accepted students and newcomer mentors to get introduced with the wider Jenkins community.
...
you could start by fixing some newcomer-friendly issues which are listed on the min event page.
