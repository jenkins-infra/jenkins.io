...
* Migrate plugin documentation as documented in these link:/blog/2019/10/21/plugin-docs-on-github/[guidelines]).
  List of plugins for grabs can be found in the link:https://web.archive.org/web/20250708134826/https://reports.jenkins.io/jenkins-plugin-migration.html[plugin migration progress report].
