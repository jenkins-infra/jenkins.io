...
* Jenkins Look & Feel updates: Modernize the Jenkins Web interface styling and appearance (jira:JENKINS-60919[])
** See the link:/sigs/ux/#ongoing-projects[UX SIG projects] for more info.
* Improving Jenkins Web UI accessibility (jira:JENKINS-62268[])
