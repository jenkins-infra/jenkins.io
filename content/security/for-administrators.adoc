...
Administrators should make sure to https://wiki.jenkins.io/display/JENKINS/How+to+report+an+issue[report problems] with security fixes to the Jenkins project's public issue tracker as a regression.
...
[WARNING]
The extensibility of Jenkins makes it imposible to provide definitive answers about exploitability and impact in all cases.
...
* link:/doc/book/managing/security/[Managing Security in the Jenkins Handbook]
* link:/doc/book/system-administration/security/[Securing Jenkins in the Jenkins Handbook]
