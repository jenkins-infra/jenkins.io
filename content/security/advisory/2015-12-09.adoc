...
NOTE: If you rely on the previous behavior, or in case of compatibility problems with certain plugins, you can modify the header sent by Jenkins. Learn more: link:https://www.jenkins.io/doc/book/system-administration/security/configuring-security-policy[Configuring Content Security Policy].
