...
- id: SECURITY-3075
  ...
  description: |-
    ...
    * Push mode for durable task logging is enabled.
      This is a hidden option in https://plugins.jenkins.io/workflow-durable-task-step/[Pipeline: Nodes and Processes] that can be enabled through the lipnk:/doc/book/managing/system-properties/[Java system property] `org.jenkinsci.plugins.workflow.steps.durable_task.DurableTaskStep.USE_WATCHING`.
