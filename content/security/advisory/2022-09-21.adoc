...
- id: SECURITY-2886
  ...
  description: |-
    ...
    NOTE: As of publication, the Jenkins security team is unaware of any vulnerable help icon/tooltip in Jenkins core or plugins published by the Jenkins project.
