...
Another vulnerability allowed an attacks to bypass the CSRF protection mechanism in place, thereby mounting more CSRF attackers. These attacks allow an attacker without direct access to Jenkins to mount an attack.
