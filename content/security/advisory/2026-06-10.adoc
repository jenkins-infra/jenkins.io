...
- id: SECURITY-3711+3755
  reporter: Takumi Katanoda (SECURITY-3711); Fushuling@secsys from Fudan University
...
- id: SECURITY-3713
  ...
  description: |-
    ...
    NOTE: This vulnerability has been reported through the link:/blog/2025/12/10/jenkins-bug-bounty-program-yeswehack-european-commission/[Jenkins Bug Bounty Program sponsored by the European Commission].
- id: SECURITY-3721
  reporter: Takumi Katanoda, and, independently, Kartik T Nair (@k0w4lzk1) from Team bi0s
