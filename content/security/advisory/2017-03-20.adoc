...
* Active Directory Plugin should be updated to version 2.1.
* DistFork Plugin should be updated to version 1.5.
* Email Extension (email-ext) Plugin should be updated to version 2.58.
* Mailer Plugin should be updated to version 1.20.
* SSH Slaves Plugin should be updated to version 1.14.
