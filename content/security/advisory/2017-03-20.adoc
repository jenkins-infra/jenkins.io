...
* Pipeline: Classpath Step Plugin should be disabled or uninstalled, and its uses replaced by use of Grape (`@Grab`), or the Pipeline libraries feature. No fix for this plugin is currently planned.
