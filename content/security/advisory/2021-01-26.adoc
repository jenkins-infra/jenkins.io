...
- id: SECURITY-2197
  ...
  description: |-
    ...
    NOTE: This issue is caused by an incorrectly applied fix for SECURITY-1452 / CVE-2021-21602 in the https://www.jenkins.io/security/advisory/2021-01-13/#SECURITY-1452[2021-01-13 security advisory].
