...
SCP publisher plugin stores credentials to other Jenkins instances in the file +be.certipost.hudson.plugin.SCPRepositoryPublisher.xml+ in the Jenkins master home directory.
These credentials were stored unencrypted, allowing anyone with local file system access to access them.
