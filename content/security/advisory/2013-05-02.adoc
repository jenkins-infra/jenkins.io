...
There's also a related vulnerability where the permission check on this ability is done imprecisely, which may affect those who are running Jenkins instances with a javadoc:AuthorizationStrategy[custom authorization strategy] plugin.
