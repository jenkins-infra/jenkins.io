...
NOTE: If you do not have an account, please signup for one in the link:https://accounts.jenkins.io/[Account application] that is used to manage the authentication within the Jenkins project. Registering an account directly in Jira will not work.
