...
* Issues in issues.jenkins.io are publicly accessible, and anyone can sign up to become an authenticated user.
  This is deliberate, the Jenkins project hosts https://www.jenkins.io/participate/report-issue/[a public issue tracker].
...
* DMARC/DKIM/SPF configuration of googlegroups.com, which we use for our https://www.jenkins.io/mailing-lists/[mailing lists].
