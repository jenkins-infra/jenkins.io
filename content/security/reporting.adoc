...
NOTE: We are currently running a Bug Bounty Program (November 2025 – November 2026). If a vulnerability is within scope, it can be submitted through link:https://yeswehack.com/programs/jenkins-bug-bounty-program/[the program on YesWeHack].
...
Starting on November 24, 2025, and lasting for 12 months, we have a Bug Bounty Program funded by the European Commission and managed through YesWeHack.

For more details please see link:/blog/2025/12/10/2025-12-10-jenkins-bug-bounty-program-yeswehack-european-commission/[the announcement blog post] and link:https://yeswehack.com/programs/jenkins-bug-bounty-program/[the program on YesWeHack].
