...
* Jenkins infrastructure projects, such as https://www.jenkins.io/[jenkins.io] or more generally the repositories hosted in https://github.com/jenkins-infra[jenkins-infra GitHub organization]
** The infrastructure security is in the scope of the link:/project/team-leads/#infrastructure[Infrastructure Officer] and their team
