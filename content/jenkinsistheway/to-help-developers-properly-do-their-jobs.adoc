...
sub_title: CI/CD for Leading French Bank
submitted_by: Christophe Michaux
tag_line: DevOps engineer drives DevOps with a Jenkins assist.
image: /images/jenkinsistheway_stories/noun_money-computer_573835.png
industries:
  - Banking
