...
sub_title: New Tournament Software with Jenkins
submitted_by: Alexis Couvreur
tag_line: >-
  Faster builds and automated release cycles for smoother performance and more
  control.
image: /images/jenkinsistheway_stories/noun_online-game_2065652.png
industries:
...
image:/images/jenkinsistheway_stories/alex.jpeg[image,width=200,height=200]
