...
. Install the link:https://plugins.jenkins.io/docker-plugin/[Docker Plugin] through the *Manage Jenkins > Manage Plugins* page.
...
. A video on writing a pipeline script in Jenkins:
