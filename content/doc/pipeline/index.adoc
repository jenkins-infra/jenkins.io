...
Note: You can also create complex and multibranch pipelines in the script entry
...
the BRANCH_NAME environment variable. In multiibranch pipelinss, the *checkout
