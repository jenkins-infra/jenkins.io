...
. Click the *X* at the top-right to return to the *Activity* page of the Blue
  ...
  *Note:* Since your browser is likely to continue running the application's
  ...
  off the `serve` process. Read more about how to clear this content in
  <<clearing-the-app-from-your-browser,Clearing the app from your browser>>
  below.
...
To clear this content from your browser:
