...
title: Using Jenkins to build a Node.js and React project with npm
section: doc
---
...
your project using Jenkins, then this tutorial is for you.
...
. Begin cloning your forked `simple-node-js-react-npm-app` repository (on
  ...
  that `simple-node-js-react-npm-app` will be cloned within the following
...
. ( _Optional_ ) On the next page, specify a brief description for your Pipeline
  ...
  build a simple Node.js and React project using Jenkins.`)
...
Node.js and React project in Jenkins. Your Pipeline will be created as a
...
(i.e. within the `/var/jenkins_home/workspace/simple-node-js-react-npm-app`
...
directory from the root of the `simple-node-js-react-npm-app` repository.
...
Node.js and React projects that integrate with other technology stacks.
