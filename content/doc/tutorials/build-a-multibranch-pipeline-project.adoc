...
. Jenkins has found our three branches, and no pull requests for the time being. +
...
. Jenkins found a `Jenkinsfile` in each branch, and that it has already built each branch.
