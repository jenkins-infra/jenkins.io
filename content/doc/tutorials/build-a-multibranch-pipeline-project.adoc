...
. kbd:[Ctrl]-Click or kbd:[Cmd]-Click the `\http://localhost:3000` link to view your Node.js and React application running in development mode (with the `npm start` command) in a new web browser tab.
