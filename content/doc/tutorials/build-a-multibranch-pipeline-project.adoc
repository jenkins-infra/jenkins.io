...
Select link:https://gitpod.io/?autostart=true#https://github.com/jenkins-docs/quickstart-tutorials[that link] to open a new browser tab with a GitPod workspace where you'll be able to start the Jenkins instance, and run the rest of the tutorial.
...
. In the *Enter an item name* box, type `building-a-multibranch-pipeline-project`, select *Multibranch Pipeline* and then *OK*.
+
[.boxshadow]
...
. In the *Branch Sources* section, utilize *Add source* and select *GitHub*.
...
. You can now Select *Save* to save your new Pipeline project. +
...
. You can now scroll up and Select *Building a Multibranch Pipeline Project* to access the main page of your new Multibranch Pipeline project.
+
[.boxshadow]
...
. Go back to Jenkins again, log in again if necessary, Select the *Building a Multibranch Pipeline Project* link if it is visible, or on *Dashboard* and then on the *Building a Multibranch Pipeline Project* link.
...
. Select `master` to see a new Pipeline being built. +
[.boxshadow]
...
. Utilize `#2` or on the latest build number to see the details of the build. +
[.boxshadow]
image:tutorials/multibranch-pipeline/2nd-build-details.png[alt="2nd build details",width=100%]
. Select *Pipeline Overview* on the left to see the stages of the Pipeline. +
[.boxshadow]
image:tutorials/multibranch-pipeline/build-2-pipeline-overview.png[alt="Pipeline overview",width=100%]
. Utilize *Test* and then on the green part to see the details of the test stage. +
[.boxshadow]
...
. Select *master* to see a new Pipeline being built.
. Utilize `#3` or on the latest build number to see the details of the build.
. Select *Pipeline Overview* on the left to see the stages of the Pipeline. +
[.boxshadow]
...
[.boxshadow]
image:tutorials/multibranch-pipeline/build-development-branch.png[alt="Build the development branch",width=100%]
