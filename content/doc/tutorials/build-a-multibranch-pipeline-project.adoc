...
. You can now click on `master` to see a new Pipeline being built. +
[.boxshadow]
...
. You can now click on `#2` or on the latest build number to see the details of the build. +
[.boxshadow]
image:tutorials/multibranch-pipeline/2nd-build-details.png[alt="2nd build details",width=100%]
. You can now click on *Pipeline Overview* on the left to see the stages of the Pipeline. +
[.boxshadow]
image:tutorials/multibranch-pipeline/build-2-pipeline-overview.png[alt="Pipeline overview",width=100%]
. You can now click on *Test* and then on the green part to see the details of the test stage. +
[.boxshadow]
