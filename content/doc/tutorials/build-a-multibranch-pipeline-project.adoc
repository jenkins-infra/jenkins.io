...
. Select the *Deliver for production* stage and then the top green *Shell Script* step to expand its contents and scroll down until you see the `\http://localhost:5000` link. +
[.boxshadow]
