...
Jenkins will now scan your remote repository for branches and create a Pipeline for each branch that contains a `Jenkinsfile`. This is the file that defines the Pipeline's behavior.
+
[.boxshadow]
