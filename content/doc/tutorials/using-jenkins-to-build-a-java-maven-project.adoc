...
. Begin cloning your forked `simple-java-maven-app` repository (on GitHub)
  ...
  `simple-java-maven-app` will be cloned into the following locations on these
  platforms:
* Mac OS X - `/Users/<your-username>/GitHub/Documents`,
* Linux - `/home/<your-username>/GitHub` or
* Windows - `C:\Users\<your-username>\GitHub\Documents`,
+
...
* For Linux - `/home/GitHub/simple-java-maven-app` or
