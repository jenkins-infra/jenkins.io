...
. Click *Run* at the top left, then quickly click the *OPEN* link which appears
  ...
  on the Blue Ocean interface to access this feature.
+
WARNING: It's quite possible that since Maven continues to download artifacts will need to be
downloaded during this final `Deliver` stage, Maven will attempt to
+
