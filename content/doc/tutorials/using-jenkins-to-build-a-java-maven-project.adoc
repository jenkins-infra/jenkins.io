...
. Ensure you are signed in to your GitHub account. +
  *Tip:* If you don't yet have a GitHub account, sign up for a free one on the
...
. In the *Repository URL* field, specify the directory path of your locally
  cloned repository above, which is your user account/home directory on your
  host machine, mapped to the `/home` directory of the Jenkins/Blue Ocean
  container - i.e.
* For Mac OS X - `/home/Documents/GitHub/simple-java-maven-app`
