...
When you first access a new Jenkins instance are asked to unlock it using an
...
being configured and the suggested plugins being installed. This process may take
a few minutes.
