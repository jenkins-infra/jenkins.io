...
. The private key file is downloads automatically.
...
You can make modifications to the rules for a security group any time, and the new rules take effect immediately.
