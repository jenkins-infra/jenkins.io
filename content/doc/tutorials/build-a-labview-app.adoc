...
depend on the speed of your machine and whether or not you've already https://jenkins.io/doc/book/installing/[installed Jenkins] from link:..[another tutorial].
