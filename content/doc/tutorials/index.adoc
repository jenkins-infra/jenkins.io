...
concepts. Choose the tutorial that's relvant to your technology stack:
...
The following tutorials show how to use features of Jenkins to facilitate
implementing CI/CD processes to build your applications:
