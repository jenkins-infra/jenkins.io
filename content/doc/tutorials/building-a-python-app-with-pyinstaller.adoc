...
to the `/home` of the Jenkins container (noting that `/home` was previously
mapped to your host operating system's `$HOME` directory).
<3> Exit out of your Jenkins container's terminal prompt.
