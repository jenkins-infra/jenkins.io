...
*Note:* Be aware that unlike the link:..[other tutorials], this tutorial
requires approximately 500 MB more Docker image data to be downloaded in order
to run all stages of the complete Pipeline.
