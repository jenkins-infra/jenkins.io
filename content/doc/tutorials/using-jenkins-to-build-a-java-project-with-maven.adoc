...
title: Using Jenkins to build a Java project with Maven
section: doc
---
...
building your project using Jenkins, then this tutorial is for you.
...
. ( _Optional_ ) On the next page, specify a brief description for your Pipeline
  ...
  build a simple Java project with Maven using Jenkins.`)
...
project with Maven in Jenkins. Your Pipeline will be created as a `Jenkinsfile`,
...
and Maven projects that integrate with other technology stacks.
