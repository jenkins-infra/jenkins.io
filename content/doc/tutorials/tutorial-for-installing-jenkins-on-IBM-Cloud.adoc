...
* Select on **Enter or Select Namespace** and choose the default Namespace or use a custom one
...
* Select on **Parameters with default values**, You can set deployment values or use the default ones
...
* Now you are at you clusters overview, here Select on **Actions** and **Web terminal** from the dropdown menu
