...
be building the same application although this time, completely through Blue
Ocean. Since Blue Ocean provides a simplified Git-handling experience, you'll be
...
agent",width=50%] +
  *Note:* For an explanation of these values, refer to annotations *1* and *2*
  of the Declarative Pipeline at the
...
directive",width=50%] +
  *Note:* For an explanation of this directive and its step, refer to
  annotations *1* and *3* of the Declarative Pipeline at the
...
step",width=50%] +
  *Note:* For an explanation of this step, refer to annotation *3* of the
  Declarative Pipeline at the
...
. In the resulting *Deliver / Shell Script* panel, specify
  ...
  image:tutorials/pipeline-in-blueocean-16a-return-from-step-icon.png[alt="Return
  from step icon",width=3%] to return to the main Pipeline editor. +
  *Note:* For an explanation of this step, refer to annotation *5* of the
  Declarative Pipeline at the
  link:../building-a-node-js-and-react-app-with-npm/#add-a-final-deliver-stage-to-your-pipeline[``Add
  a final deliver stage...'' section of the building a Node.js and React
  application] tutorial.
