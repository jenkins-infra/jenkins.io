...
. Click *Create Pipeline*. +
  ...
  *Note:* Under the hood, a Pipeline project created through Blue Ocean is
  actually multibranch Pipeline. Therefore, Jenkins would looking for the
  presence of at least one Jenkinsfile in any branch of your repository.


=== Create your initial Pipeline

. Following on from creating your Pipeline project
  (<<create-your-pipeline-project-in-blue-ocean,above>>), on the
