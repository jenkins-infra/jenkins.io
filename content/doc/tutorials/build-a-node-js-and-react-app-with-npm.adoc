...
repository on GitHub) generates a web page with the content "Learn React"
...
Obtain the simple "Learn React" Node.js and React application from GitHub,
...
. Click the `\http://localhost:3000` link to view your Node.js and React
  ...
  see a page/site with the title *Learn React* on it. +
