...
This command also generates a Cobertura XML report, which is saved to the `SimpleWebApi.Test/TestResults` directory within the `/var/jenkins_home/workspace/simple-dotnet-web-app` directory in the Jenkins container.
...
You may want to have a look at the delivered artifacts. You can click on *Dashboard* and then *dotnet-tutorial*. You will see the *Last Sucessful Artifacts*.
[.boxshadow]
