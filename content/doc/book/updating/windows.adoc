...
The simplest way to update your Jenkins instance on Windows is using Web UI or by downloading the
link:https://www.jenkins.io/download/[Latest Jenkins WAR] 
and replacing it with the old one and restarting your Jenkins instance.
