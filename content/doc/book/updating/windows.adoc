...
* Replacing the link:/doc/book/updating/windows/#replacing-the-war-file[WAR File].

However, To upgrade Jenkins, you should follow the same steps you used for installation.

=== Upgrading via MSI Installer

You can download the latest LTS or Weekly MSI Installer to upgrade Jenkins.

Just download the Jenkins link:/download/#downloading-jenkins[MSI Installer] from here and install the latest Jenkins LTS or Weekly.
For more information refer to the link:/doc/book/installing/windows/#windows-msi-installers[Installing Jenkins On Windows via MSI Installer] page.
