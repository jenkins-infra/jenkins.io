...
For example, if my local PC is running Jenkins at port 8080, it will be `http://localhost:8080/exit`.
...
This is important if the upgrade process fails because you won't lose the backup of your Jenkins instance.
