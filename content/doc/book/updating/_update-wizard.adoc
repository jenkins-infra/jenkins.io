...
To upgrade Jenkins from Java 8 to Java 11, Visit this 
link:https://www.jenkins.io/doc/administration/requirements/upgrade-java-guidelines/[Upgrade Java Guideline]
and 
link:https://www.jenkins.io/doc/administration/requirements/java/[Java requirements].
