...
The Blue Ocean Activity View shows the all activity related to one
repository Pipeline.
...
* *Pipeline Name* - Clicking on this navigates to the
<<#activity, default activity subsection>>
...
Clicking one of these buttons will navigate to that subsection of the Activity View.

== Activity

The default subsection of the Activity View, the "Activity" subsection,
shows a list of the latest completed or in-progress Runs.
Each line in the list shows the <<dashboard#pipeline-run-status, status>> of the Run,
...
Those actions can be done from the "<<#branches, branches>>" subsection.
...
image:blueocean/activity/branches.png[Branches Subsection of Activity View, role=center]
