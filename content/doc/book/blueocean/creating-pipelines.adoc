...
///
=== Create a Pipeline project from a repository on GitHub Enterprise
///

=== Create a Pipeline project from a repository on Bitbucket Cloud
...
current/logged in Jenkins user in Blue Ocean, Jenkins registers this credential
with the following details for your Jenkins user:
