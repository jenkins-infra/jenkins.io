...
as `Jenkinsfile`&zwj;s, Blue Ocean does not support other Git connection
protocols like HTTP or HTTPS. Therefore, you will need to configure Blue Ocean's
public SSH key with your Git server instead (as described
...
To create your Pipeline project directly for a repository on Bitbucket Cloud,
