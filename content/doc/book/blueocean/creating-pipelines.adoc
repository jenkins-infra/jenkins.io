...
Local repositories are limited to file system access. They are usually
...
. Back in Blue Ocean, paste the access token into the *Your GitHub access token*
  ...
  link:#choose-your-github-account-organization-and-repository[choose your GitHub account/organization and repository]. +
