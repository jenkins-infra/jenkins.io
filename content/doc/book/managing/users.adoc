...
To remove a user from Jenkins, we have two options.
Let us take a look into both of them : 
...
+
image::managing/delete-users-alternative.png[Deleting user alternative,width=600]
