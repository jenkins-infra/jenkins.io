...
+
image::managing/create-users.png[Accessing the Create User Page,width=800]

. Select **Create User** to save the new user.
+
For example:
+
image::managing/create-users-example.png[Create User Page Example,width=800]
...
+
image::managing/delete-users.png[Deleting User,width=800]
+
