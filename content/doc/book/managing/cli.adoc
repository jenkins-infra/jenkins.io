...
* SSH client was build to be a generic tool to serve several propouses, so it don't offer an easy-way to do basic things that are common and specific to jenkins enviroment. Therefore use Jenkins CLI maybe will increase your productivity and your user experience.
