...
while there are no currently known vulnerabilities, several have been reported and patched in the past.
As of 2.54, the custom client in its default (`-http`) or `-ssh` modes is considered secure.
