...
A small group of administrators must still have write access to the UI configuration fields,
and they should understand that JCasC will overwrite changes they make on the UI.
