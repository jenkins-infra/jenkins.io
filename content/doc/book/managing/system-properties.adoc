...
- name: jenkins.security.s2m.CallableDirectionChecker.allowAnyRole
  ...
  description: |
    ...
    As of early November 2021, it is unclear whether this can safely be set to `false`, or whether that would cause problems with some remoting built-in callables.
