...
- name: hudson.security.csrf.DefaultCrumbIssuer.EXCLUDE_SESSION_ID
  ...
  description: |
    ...
    Since Jenkins 2.TODO, this is the only part of the CSRF crumb that is tied to a user session/machine.
...
- name: jenkins.model.Jenkins.crumbIssuerProxyCompatibility
  ...
  description: |
    ...
    This flag is unused since Jenkins 2.TODO, as the IP address is no longer part of the CSRF crumb.
