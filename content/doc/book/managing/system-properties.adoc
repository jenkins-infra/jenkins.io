...
# - internal: Not intended to be set by administrators, developers, or packaging scripts at all.
...
- name: hudson.consoleTailKB
  ...
  description: |
    ...
    This property has no effect from Jenkins 2.4 (inclusive) until 2.98/2.89.3 (exclusive), see JENKINS-48593.
