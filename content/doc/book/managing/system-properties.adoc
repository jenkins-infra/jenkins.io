...
- name: jenkins.security.FIPS140.COMPLIANCE
  ...
  description: |
    ...
    Not all features/plugins have been adapted, and this indicates a preference only, merely setting this flag to `true` does not make Jenkins and its plugins FIPS-140 compliant see <<system-administraton/FIPS-140#,Jenkins and FIPS-140 Overview>> for more information.
