...
`hudson.model.DirectoryBrowserSupport.CSP`::
    ...
    **Since:** 1.625.3, 1.641 +
    **Description:** Determines the Content Security Policy header sent for static files served by Jenkins. See link:../../system-administration/security/configuring-content-security-policy/[Configuring Content Security Policy] for more details.
