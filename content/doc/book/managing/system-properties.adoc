...
`hudson.model.DirectoryBrowserSupport.CSP`::
    ...
    **Since:** 1.625.3, 1.641 +
    **Description:** Determines the Content Security Policy header sent for static files served by Jenkins. See https://www.jenkins.io/doc/book/system-administration/security/configuring-security-policy/[Configuring Content Security Policy] for more details.
