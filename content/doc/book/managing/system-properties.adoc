...
- name: hudson.model.Hudson.initLogLevel
  ...
  - obsolete
  description: |
    Deprecated: Backward-compatible fallback for `jenkins.model.Jenkins.initLogLevel`. Removed since TODO

- name: hudson.model.Hudson.killAfterLoad
  tags:
  - obsolete
  description: |
    Deprecated: Backward-compatible fallback for `jenkins.model.Jenkins.killAfterLoad`. Removed since TODO

- name: hudson.model.Hudson.logStartupPerformance
  tags:
  - obsolete
  description: |
    Deprecated: Backward-compatible fallback for `jenkins.model.Jenkins.logStartupPerformance`. Removed since TODO

- name: hudson.model.Hudson.parallelLoad
  tags:
  - obsolete
  description: |
    Deprecated: Backward-compatible fallback for `jenkins.model.Jenkins.parallelLoad`. Removed since TODO

- name: hudson.model.Hudson.workspaceDirName
  tags:
  - obsolete
  description: |
    Deprecated: Backward-compatible fallback for `jenkins.model.Jenkins.workspaceDirName`. Removed since TODO
...
- name: hudson.remoting.ClassFilter
  ...
  description: |
    ...
    See jep:200#backwards-compatibility[JEP-200] and https://issues.jenkins-ci.org/browse/JENKINS-47736[JENKINS-47736].
...
- name: hudson.slaves.ChannelPinger.pingInterval
  ...
  since: 1.405
  description: |
    *(Deprecated since 2.37)* Frequency (in minutes) of https://wiki.jenkins.io/display/JENKINS/Ping+Thread[pings between the master and agents]
...
- name: hudson.slaves.ChannelPinger.pingIntervalSeconds
  ...
  since: 2.37
  description: |
    Frequency of https://wiki.jenkins.io/display/JENKINS/Ping+Thread[pings between the master and agents], in seconds
...
- name: hudson.slaves.ChannelPinger.pingTimeoutSeconds
  ...
  since: 2.37
  description: |
    Timeout for each https://wiki.jenkins.io/display/JENKINS/Ping+Thread[ping between the master and agents], in seconds
...
- name: hudson.Util.maxFileDeletionRetries
  ...
  description: |
    ...
    See https://issues.jenkins-ci.org/browse/JENKINS-10113[JENKINS-10113] and https://issues.jenkins-ci.org/browse/JENKINS-15331[JENKINS-15331].
...
- name: hudson.util.Secret.provider
  ...
  since: 1.360
  description: |
    Force a particular crypto provider; with Glassfish Enterprise set value to `SunJCE` to workaround https://issues.jenkins-ci.org/browse/JENKINS-6459[JENKINS-6459] and GLASSFISH-11862.
...
- name: jenkins.InitReactorRunner.concurrency
  ...
  description: |
    ...
    For example, 24 CPU Jenkins Master host use this: `-Dhudson.InitReactorRunner.concurrency=192`
...
- name: jenkins.model.StandardArtifactManager.disableTrafficCompression
  ...
  since: 2.196
  description: |
    `true` to disable GZIP compression of artifacts when they're transferred from agent nodes to master.  Uses less CPU at the cost of increased network traffic.
...
- name: jenkins.security.ApiTokenProperty.showTokenToAdmins
  ...
  description: |
    ...
    This was set to `false` as part of https://wiki.jenkins-ci.org/display/SECURITY/Jenkins+Security+Advisory+2015-11-11#JenkinsSecurityAdvisory2015-11-11-APItokensofotherusersavailabletoadmins[SECURITY-200]
...
- name: jenkins.ui.refresh
  ...
  description: |
    ...
    See https://issues.jenkins-ci.org/browse/JENKINS-60920[JENKINS-60920].
