...
Jenkins provides a couple of different methods for installing plugins on the controller:
...
[CAUTION]
====
If the list of available plugins is empty, the controller might be incorrectly
...
The controller will need to be restarted before the plugin is loaded and
