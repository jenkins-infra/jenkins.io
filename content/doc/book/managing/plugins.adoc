...
Only the score is shown, but the details behind this value are available on the link:https://plugins.jenkins.io[plugins site], in the health score section of each plugin:
