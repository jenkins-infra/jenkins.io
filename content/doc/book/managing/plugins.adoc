...
The data can be related to the source code of the plugin, the content of the plugin repository or external metrics about the plugin such as number of open pull requests, etc.
...
Review the recommendations on the plugin site to improve the plugin score.
