...
This project is gather data from each plugin.
The data can be related to the source code of the plugin, the content of the plugin repository or external metrics about the plugin as number of open pull requests.
