...
==== Notable plugins known to be affected by enforcing Content Security Policy protection
...
As a workaround, administrators can allow the domain `avatars.githubusercontent.com` for the `img-src` directive using plugin:csp[Content Security Policy Plugin].
