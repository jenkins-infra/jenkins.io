...
This concept is called _distributed builds_ in Jenkins, and you can learn more about this in link:/doc/book/scaling/architecting-for-scale/[Architecting for Scale].
