...
It allows users to view agent configuration details without the ability to modify them.
...
It allows users to view job configuration details without the ability to modify them.
