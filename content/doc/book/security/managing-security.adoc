...
The "Configure Global Security" section section of the web UI allows a Jenkins administrator to
...
Authentication is the primary mechanism for securing a Jenkins environment
