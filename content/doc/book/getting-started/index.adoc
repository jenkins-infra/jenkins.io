...
Jenkins is an extensible automation server that enables developers to build, test, and deliver software through continuous integration and continuous delivery (CI/CD) pipelines.
This page helps new users navigate the handbook by linking to installation, usage, and administration sections.
