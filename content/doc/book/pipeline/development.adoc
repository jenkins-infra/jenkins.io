...
The link:https://github.com/shenxianpeng/jenkinsfilelint[jenkinsfilelint] pre-commit hook validates Jenkinsfiles before commit by using the <<linter,Pipeline Linter API>> of a Jenkins controller.
