...
If you only have _Overall/Manage_ permission,
you can still configure global libraries,
but only “untrusted” ones that run in the Groovy sandbox
just like typical Pipeline scripts.
