...
|   +- main
|       +- groovy                   # Standard Maven groovy source directory
|           +- org
|               +- foo
|                   +- Baz.groovy   # for org.foo.Baz class
org
|       +- foo
|           +- Bar.groovy           # for org.foo.Bar class
+- vars
...
The `src` directory should look like either standard Java source directory structure or
standard Maven groovy source directory structure.
