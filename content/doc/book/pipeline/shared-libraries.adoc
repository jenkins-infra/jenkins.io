...
This video reviews using resource files from a Shared Library. A link to the example repository used is also provided in the link:https://youtu.be/eV7roTXrEqg[video description].
