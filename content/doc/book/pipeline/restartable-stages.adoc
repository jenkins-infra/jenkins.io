---
layout: section
title: Restarting or Rerunning a Pipeline
---
ifdef::backend-html5[]
:description:
:author:
...
TODO: Just move from development.adoc to here?
...
TODO: Insert screenshot of the build page with the side panel link here.
...
TODO: Screenshot of the "choose a stage" page
