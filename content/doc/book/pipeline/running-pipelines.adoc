...
Restarting stages can also be done visually using the link:https://plugins.jenkins.io/pipeline-graph-view/[Pipeline Graph View plugin].
Once your Pipeline has completed, whether it succeeds or fails, you can click on the stage you wish to restart.
You can then click the `Restart` button for that stage within the details panel.
