...
In simple terms, it describes the stages and steps Jenkins will run to build, test, and deploy your application.

- `pipeline` defines the overall workflow.
- `agent` tells Jenkins where the pipeline should run.
- `stages` groups the main parts of the workflow.
