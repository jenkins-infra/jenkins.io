...
// TODO: Explain that you can nest multiple conditions directly in when { }, in
// which case all of the conditions must be true, same as allOf {}.
...
not:: Execute the stage when the nested condition is false. For example:
`when { not { branch 'master' } }`

allOf:: Execute the stage when all of the nested conditions are true. For
