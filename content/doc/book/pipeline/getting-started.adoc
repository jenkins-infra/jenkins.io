...
To take full advantage of these features, ensure the Pipeline Graph View plugin is installed on your Jenkins controller.
You can read more about it in the link:/blog/2025/05/02/pipeline-graph-view/[Pipeline Graph View blog post].
