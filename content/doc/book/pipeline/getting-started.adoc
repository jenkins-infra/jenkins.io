...
+
[.boxshadow]
image:pipeline/new-item-creation.png[alt="Jenkins New Item page with item name as *example-pipeline* and options for item type include: Freestyle project, Pipeline, Multi-configuration project, Folder, Multi-branch Pipeline and Organization Folder.",width=100%]
