...
* <<#using-blue-ocean,Using Blue Ocean>> - after setting up a Pipeline project
  in Blue Ocean, the Blue Ocean UI helps you write your Pipeline's
  `Jenkinsfile` and commit it to source control.
* <<#using-the-classic-ui,Using the classic UI>> - you can enter a basic
