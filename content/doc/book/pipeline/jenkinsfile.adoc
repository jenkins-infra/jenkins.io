...
Unlike secret text, secret files cater for credentials which might be:
...
text, usernames and passwords, or secret files - i.e SSH keys or certificates,
then use Jenkins' *Snippet Generator* feature, which you can access through
Jenkins' classic UI.
