...
complex process on its way to being released. This process involves not only
building the software, but the progression of this built software (each of which
is called a "build") through multiple stages of testing and deployment.
