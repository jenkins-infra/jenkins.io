...
** username: jenkins
** Private Key: select `Enter directly` and press the Add button to insert your private key;
+
[NOTE]
====
If you generate it at the default location use the command to print it on terminal: `cat ~/.ssh/jenkins_agent_key`
====
