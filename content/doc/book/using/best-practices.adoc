...
A continuous integration build is a possible first step towards reproducible builds, but is usually not sufficient

See the link:https://reproducible-builds.org/[reproducible builds site] for more details.
