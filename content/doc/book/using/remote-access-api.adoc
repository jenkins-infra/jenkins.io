...
Wrapper libraries are also available for languages such as Python.
...
When you specify a positive depth value, the subtree cut-off happens that much later.
...
https://github.com/arangamani/jenkins_api_client[GitHub].
