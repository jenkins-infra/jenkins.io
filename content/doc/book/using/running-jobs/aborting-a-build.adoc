...
http://en.wikipedia.org/wiki/SIGTERM[SIGTERM] on Sun's JREs. On Windows,
this is done through
http://msdn.microsoft.com/en-us/library/ms686714(VS.85).aspx[TerminateProcess]
API.
* If it was waiting for a completion of some computation in a agent, the
