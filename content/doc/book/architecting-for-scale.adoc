...
* *Remote management facilities (WMI + DCOM)*: With this approach, which
  utilizes the
  https://wiki.jenkins.io/display/JENKINS/Windows+Slaves+Plugin[Windows
...
* The https://wiki.jenkins.io/display/JENKINS/Amazon+EC2+Plugin[EC2 Plugin]
...
* The https://wiki.jenkins.io/display/JENKINS/JClouds+Plugin[JCloud plugin]
...
the https://wiki.jenkins.io/display/JENKINS/Mock+Security+Realm+Plugin[Mock
