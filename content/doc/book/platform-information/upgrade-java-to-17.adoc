...
When upgrading your Jenkins controller to Java 17, make sure all agents are running Java 17 or later.
...
This plugin can also be configured to automatically disconnect agents running an unsupported Java version.
