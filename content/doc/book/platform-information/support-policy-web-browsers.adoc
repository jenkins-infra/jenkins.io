...
* 2025-06-16 - Move Firefox ESR to level 2 from level (link:https://groups.google.com/g/jenkinsci-dev/c/jbhWs4JZ-j4/m/yBXEBW3DAAAJ[discussion in the developer mailing list])
