...
For migration planning and validation guidance when moving controllers and agents to Java 25, use the link:/doc/book/system-administration/java25-migration/[Java 25 migration cookbook].
