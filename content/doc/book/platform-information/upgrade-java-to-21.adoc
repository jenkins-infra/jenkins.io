...
When upgrading your Jenkins controller to Java 21, make sure all agents are running Java 21 or later.
...
You can configure this plugin to automatically disconnect agents running an unsupported Java version.
