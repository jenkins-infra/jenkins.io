...
* This link:https://raw.githubusercontent.com/zaycodes/jenkins.io/jenkins-on-kubernetes-sample-yaml-files/content/doc/tutorials/kubernetes/installing-jenkins-on-kubernetes/jenkins-deployment.yaml[file] is defining a Deployment as indicated by the `kind` field.
...
* This link:https://raw.githubusercontent.com/zaycodes/jenkins.io/jenkins-on-kubernetes-sample-yaml-files/content/doc/tutorials/kubernetes/installing-jenkins-on-kubernetes/jenkins-service.yaml[file] is defining a Service as
