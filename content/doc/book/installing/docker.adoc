...
link:https://easypanel.io[Easypanel] is a self-hosted Docker deployment platform. It maintains a one-click deployment template for Jenkins:

image:https://easypanel.io/img/deploy-on-easypanel-40.svg[Deploy on Easypanel,link=https://easypanel.io/templates/jenkins]

image::installing/easypanel-panel.jpg[Jenkins service running in the Easypanel dashboard]
