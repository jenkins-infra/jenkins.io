...
NOTE: Because this is an offline installation, Jenkins cannot download plugins.
To skip plugin installation during setup:
...
You can install plugins manually later using the
link:https://github.com/jenkinsci/plugin-installation-manager-tool[Plugin Installation Manager Tool]
described above.
