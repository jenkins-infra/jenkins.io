...
Jenkins requires Java in order to run, yet certain distributions don't include this by default and  link:/doc/book/platform-information/support-policy-java/[some Java versions are incompatible] with Jenkins.
