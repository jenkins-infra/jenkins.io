...
Jenkins requires Java in order to run, yet certain distros don't include this by default and  link:https://www.jenkins.io/doc/administration/requirements/java/[some Java version are incompatible] with jenkins.
