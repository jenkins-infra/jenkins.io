...
operating system (e.g. macOS, Linux and Windows) or cloud service (e.g. AWS and
Azure) which is also running Docker.
...
store] website and click the *Docker Community Edition* which is suitable for
your operating system or cloud service. Follow the installation instructions on
their website.
