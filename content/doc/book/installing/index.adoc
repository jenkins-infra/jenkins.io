...
Jenkins requires Java in order to run, yet certain distributions don't include this by default and  link:doc/administration/requirements/java/[some Java version are incompatible] with Jenkins.
