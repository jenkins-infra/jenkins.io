...
Next, the *Customize Jenkins* page appears. Here you can install any number of
...
* This page may indicate *Jenkins is almost ready!* instead and if so, click
  *Restart*.
* If the page does not automatically refresh after a minute, use your web browser
