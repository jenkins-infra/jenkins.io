...
than running Jenkins using *LocalSystem(Windows equivalent of root)* which will grant Jenkins full access
...
image::/images/post-images/2019-02-01-windows-installer/new_installer_3.png[alt="Account Selection",width=80%]
