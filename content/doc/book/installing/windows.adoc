...
NOTE: Jenkins requires a supported Java version to run.
As of recent Jenkins releases, Java 21 or newer is required.
Ensure the selected JAVA_HOME points to a compatible Java installation.
