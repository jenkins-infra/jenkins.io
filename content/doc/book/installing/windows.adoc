...
Specify the port on which Jenkins will run.
Use the *Test Port* button to validate whether the specified port is free on your machine.
...
On the *Unlock Jenkins* page, paste this password into the *Administrator password* field and click *Continue*. +
  *Notes:*
* You can also obtain the initial administrator password from the *jenkins.err.log* file located in the Jenkins home directory.
...
. In the *Select Users or Groups* dialog, find the user you wish to enter and click *OK*
