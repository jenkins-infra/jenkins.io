...
== Installation Steps Windows MSI installers
...
On opening the Windows Installer, an *Installation Setup Wizard* comes up, 
...
[.boxshadow]
image:tutorials/setup-jenkins-02-unlock-jenkins-page.jpg[alt="Unlock Jenkins page",width=80%]
...
For default installation location to C:\Program Files (x86)\Jenkins, a file called 
*initialAdminPassword* can be found under C:\Program Files (x86)\Jenkins\secrets.
...
After cpmpleting the steps above, try logging in again with the added user.
