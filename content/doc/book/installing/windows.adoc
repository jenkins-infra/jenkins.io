...
Option 1:[Recommended]:: When Installing Jenkins, it is recommended to install and run Jenkins 
as an independent Windows service using a *local or domain user*, as it is much safer 
than running Jenkins using *LocalSystem(Windows equivalent of root)* which will grant Jenkins full access to your machine and services.
