...
Java 8 will not use HTTP/2 unless alpn boot jar is included in the bootclasspath.
The alpn boot jar depends on your jvm version.
Refer to the link:https://www.eclipse.org/jetty/documentation/current/alpn-chapter.html#alpn-versions[Jetty documentation] to select the required version.
