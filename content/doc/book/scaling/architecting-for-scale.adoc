...
* **How important is a fast start-up time for your Jenkins controller?** The more
  ...
  the number of jobs that need to be rendered on start up.
...
The _.jar_ file can be found at:
...
** Reduces the impact of one controller's downtime to only a small subset of products
...
These factors include componentizing the application under development,
