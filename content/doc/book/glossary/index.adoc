...
:description:
:author:
:email: [jenkinsci-users@googlegroups.com](mailto:jenkinsci-users@googlegroups.com)
:sectanchors:
:toc:
endif::[]
...
LTS::
A long-term support <<release, Release>> line of Jenkins products, available
for download every 12 weeks.
...
A machine that is part of the Jenkins environment and capable
...
Pipeline:: [[pipeline]]
A user-defined model of a continuous delivery pipeline. For more information, see the
