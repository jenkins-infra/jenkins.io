...
View:: [[view]]
    A way of displaying data of Jenkins in a dashboard style. Is an extendable object, 
    so that there are a lot of different ways of e.g. listing <<job,jobs>>, showing trends, analysing data.
Workspace:: [[workspace]]
