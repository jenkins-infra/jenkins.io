...
link:https://wiki.jenkins.io/display/JENKINS/CloudBees+Folders+Plugin[Folders]
...
first-class object, and so the link:https://wiki.jenkins.io/display/JENKINS/Pipeline+Plugin[Pipeline
