...
# Make directories for [masters] JENKINS_HOME, jenkins.war lib and [agents] remote FS root, ssh privilege separation directory
...
Test masters can be connected to test agents, but this will require further
