...
* https://wiki.jenkins.io/display/JENKINS/Slave+To+Master+Access+Control[Agent To Controller Access] --- protect Jenkins controller from malicious build agents
