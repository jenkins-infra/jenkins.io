...
Full-duplex HTTP(S) transport with plain CLI protocol does not work with Apache reverse proxy,
and update it if you have settings that do work.
As a workaround, you can use the https://jenkins.io/doc/book/managing/cli/#ssh[CLI over SSH].
