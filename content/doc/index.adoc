...
There are also link:tutorials[tutorials] geared to developers who want to
...
documentation covered in the link:pipeline/tour/getting-started[Guided Tour],
link:tutorials[Tutorials] and link:book/getting-started[User Handbook] of this
documentation are based on a link:book/installing[Jenkins installation] with the
link:book/blueocean/getting-started[Blue Ocean plugins installed], as well as
the "suggested plugins", which are specified when running through the
link:book/installing/#setup-wizard[Post-installation setup wizard].
