...
If you're upgrading the JVM used to run Jenkins, particularly if you're upgrading from Java 11 to Java 17, there are some details you should know and precautions you should take.
