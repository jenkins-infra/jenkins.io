...
Jenkins uses Eclipse Temurin as its primary JDK for building and testing Java based applications. This includes:
* Container Images
* Controller Builds
* Testing Infrastructure

Some of the reasons of choosing Temurin are:
1. Its availability over a wide range of platforms, including different operating systems and architectures, over many different Java SE versions.
2. Regular maintainence and long term support provided by the Eclipse Foundation
3. Additional performance optimizations designed to improve the performance and scalability of the JDK in enterprise-level applications.
