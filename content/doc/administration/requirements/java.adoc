...
.Upgrading Java
====
Upgrading an existing Jenkins to Java 17?
Refer to the link:/doc/administration/requirements/upgrade-to-java-17[Java 17 upgrade guidelines].

Upgrading an existing Jenkins to Java 11?
Refer to the link:/doc/administration/requirements/upgrade-java-guidelines[Java 11 upgrade guidelines].
====
