...
Upgrading an existing Jenkins setup from Java 8 to Java 11? See the link:/doc/administration/requirements/upgrade-java-guidelines[upgrade guidelines].
...
The `jenkins/jenkins:jdk17` Docker image allows you to run the Jenkins controller on Java 17.
...
// TODO Actually link to a filter, or labels, or anything useful, here.
