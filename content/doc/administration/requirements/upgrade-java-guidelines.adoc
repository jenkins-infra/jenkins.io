...
These instructions will still apply to the Long Term Support release line, until the LTS release line mirrors the weekly release line Java requirements.
