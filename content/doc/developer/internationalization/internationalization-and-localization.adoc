...
https://plugins.jetbrains.com/plugin/1885-jenkins-development-support[IntelliJ
...
if you need one.)
https://www.jetbrains.com/community/opensource/#support[Jetbrains Licenses for Open Source Development]
...
To use this feature, select the message to be
internationalized, then trigger this refactoring command. It will ask you
...
IDEA places the message into the resource file and adjusts the code
