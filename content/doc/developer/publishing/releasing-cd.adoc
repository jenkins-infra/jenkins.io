...
Optionally you can also remove `.github/release-drafter.yml` as the default is to assume link:https://github.com/probot/octokit-plugin-config/blob/fa1700ed56e2c76afb4dd618bf27e7c8a445c4d8/src/util/get-config-files.ts#L37-L51[`_extends: .github`]
