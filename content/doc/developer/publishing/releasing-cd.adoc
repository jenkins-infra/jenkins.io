...
Finally, if you manually trigger the CD action it will publish a new release regardless of any labels. (May cause cause Release Drafter to rearrange release notes)
