...
As a new plugin author, its highly recommended to join the https://www.jenkins.io/mailing-lists/[mailing list] to interact with the community and to stay up to date with the latest Jenkins news.
