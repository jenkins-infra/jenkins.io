...
As a new plugin author, its highly recommended that you join the https://www.jenkins.io/mailing-lists/[mailing list] to interact with the community and to stay up to date with the latest Jenkins news.

*Please note* : Kindly refrain from asking questions or communicating in private channels. We want the communications to take place in an open environment, so that we can have healthier discussions within our community.
