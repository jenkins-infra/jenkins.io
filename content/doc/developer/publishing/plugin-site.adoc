...
GitHub topics that match entries from the link:https://github.com/jenkins-infra/update-center2/blob/master/src/main/resources/allowed-github-topics.properties[plugin label whitelist] are displayed on the plugin site.
