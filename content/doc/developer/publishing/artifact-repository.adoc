...
** See the link:https://github.com/jenkins-infra/repository-permissions-updater#requesting-permissions[readme section on requesting permissions] for more information.
