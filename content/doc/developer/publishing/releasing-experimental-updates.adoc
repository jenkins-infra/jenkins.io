...
This provides the user with flexibility to create incremental versions of Jenkins core or an upstream plugin on which under developement downstream plugin can depend upon. 
