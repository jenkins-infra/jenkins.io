...
You will receive a welcome email if your Jenkins community account was created successfully. If you do not receive an email, open a ticket at https://github.com/jenkins-infra/helpdesk.
