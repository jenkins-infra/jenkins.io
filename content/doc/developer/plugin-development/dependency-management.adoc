...
Avoid using version ranges when developing plugins, as this reduces the repeatability of builds and can create problems with proper dependency management.
