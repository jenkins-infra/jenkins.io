...
To avoid that behavior, it is possible to set a flag https://jenkinsci.github.io/maven-hpi-plugin/hpi-mojo.html#pluginFirstClassLoader[+pluginFirstClassLoader+] in the plugin’s Maven POM.
