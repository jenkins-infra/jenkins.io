...
jira:JENKINS-41827[] proposes a variant of `JenkinsRule` which would retain most of its convenience
...
A proposed feature jira:JENKINS-41196[] would make this possible.
