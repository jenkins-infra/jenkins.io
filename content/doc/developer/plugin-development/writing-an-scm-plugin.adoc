...
For the rest of this how-to, it is assumed that the plugin development environment has been set up according to the link:https://jenkins.io/doc/developer/tutorial/[Plugin tutorial].
