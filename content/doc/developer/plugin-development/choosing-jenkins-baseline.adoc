...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.477 for weekly releases, and 2.462.2 for LTS releases.
