...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.372 for weekly releases, and 2.361.4 for LTS releases.
