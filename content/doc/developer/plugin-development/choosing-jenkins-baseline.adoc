...
At the moment, the Jenkins releases *PLACEHOLDER_OLDER_LTS_POINT_HIGHS, and PLACEHOLDER_NEWER_LTS_POINT_ONE* make good core dependencies unless there are specific reasons, like new features, to choose a different release.
