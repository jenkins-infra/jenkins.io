...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.502 for weekly releases, and 2.492.3 for LTS releases.
