...
At the moment, the Jenkins releases *2.541.3 and 2.555.3* make good core dependencies.
You could also consider *2.568.1* if there are specific reasons, like new features, to want something newer.
