...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.400 for weekly releases, and 2.387.3 for LTS releases.
