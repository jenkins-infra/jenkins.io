...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.374 for weekly releases, and 2.361.2 for LTS releases.
