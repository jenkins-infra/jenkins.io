...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.489 for weekly releases, and 2.479.2 for LTS releases.
...
Something around 1 year old that does not have too many detached plugins makes a good choice and 2.479.3 would be a reasonable candidate.

## Currently recommended versions

At the moment, the Jenkins releases *2.516.3 and 2.528.3* make good core dependencies.
You could also consider *2.541.1* if there are specific reasons, like new features, to want something newer.
