...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.430 for weekly releases, and 2.426.1 for LTS releases.
