...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.513 for weekly releases, and 2.504.3 for LTS releases.
