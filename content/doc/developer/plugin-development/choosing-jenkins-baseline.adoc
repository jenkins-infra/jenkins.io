...
* *Prefer an LTS version over weekly versions.*
  The last release in a historical line (often 2.xxx.3) may be more appropriate than the initial 2.xxx.1 release,
  and may be forced by dependencies, though you may prefer to stay with 2.xxx.1 while a line is active.
