...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.476 for weekly releases, and 2.462.2 for LTS releases.
