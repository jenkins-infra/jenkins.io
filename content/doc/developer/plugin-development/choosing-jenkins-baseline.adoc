...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.502 for weekly releases, and 2.492.2 for LTS releases.
...
At the moment, the Jenkins releases *2.528.3 and 2.541.3* make good core dependencies.
You could also consider *2.555.1* if there are specific reasons, like new features, to want something newer.
