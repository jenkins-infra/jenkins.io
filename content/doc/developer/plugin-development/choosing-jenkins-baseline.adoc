...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.462 for weekly releases, and 2.452.2 for LTS releases.
