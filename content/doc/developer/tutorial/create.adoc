...
In this tutorial we're going to use the `hello-world` archetype, version 1.3, so select that:
...
<2> This tutorial is based on version 1.3 of the *hello-world-plugin* archetype, so enter *3* to select it.
