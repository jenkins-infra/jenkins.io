...
Then, add the full path of the `bin/` subdirectory extracted (for example, `~/Applications/apache-maven/bin/mvn` or `C:\Program files\Maven\bin\mvn`) to the `PATH` variable in your OS.
