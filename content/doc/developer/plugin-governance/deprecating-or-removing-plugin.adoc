...
** Otherwise, create a link:https://github.com/jenkins-infra/helpdesk/issues/new?assignees=&labels=github-permissions&template=2-github-permissions.ymlhttps://issues.jenkins.io/[help desk] ticket to archive the plugin's repository
