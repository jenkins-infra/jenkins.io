...
. Via a request in the link:https://github.com/jenkins-infra/repository-permissions-updater/?tab=readme-ov-file#requesting-permissions[Repository Permissions Updater]
. Via a request in the link:/mailing-lists[developer mailing list].
