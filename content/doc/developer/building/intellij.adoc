...
This tutorial uses IntelliJ IDEA. The steps are expected to be similar across recent versions.
...
Now, our next goal is to be able to debug Jenkins by using breakpoints in IntelliJ. Close the previous running instance by (Ctrl+C).
