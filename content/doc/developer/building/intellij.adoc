...
Install IntelliJ from link:https://www.jetbrains.com/help/idea/installation-guide.html[here]. Fork Jenkins core source code from link:https://github.com/jenkinsci/jenkins[here]. Clone the forked repository to your machine. In this tutorial, IntelliJ IDEA Version 2019.3.1 has been used.
