...
image::/images/developer/building/intellij/setup1.jpg[]

Click on Import Project, and in the popup, choose the directory where Jenkins had been cloned.

image::/images/developer/building/intellij/setup2.jpg[]

Select ‘Create project from existing sources’, and click on Next.

image::/images/developer/building/intellij/setup3.jpg[]

Click on Next

image::/images/developer/building/intellij/setup4.jpg[]

Click on Next

image::/images/developer/building/intellij/setup5.jpg[]

Click on Next

image::/images/developer/building/intellij/setup6.jpg[]

Click on Finish. IntelliJ should be ready like below.

image::/images/developer/building/intellij/setup7.jpg[]
...
image::/images/developer/building/intellij/build1.jpg[]
...
image::/images/developer/building/intellij/build2.jpg[]
...
image::/images/developer/building/intellij/debug1.jpg[]

In the toolbar, go to Run -> Edit Configurations…

image::/images/developer/building/intellij/debug2.jpg[]

Click on the ‘+’ icon so we can add a new configuration.

image::/images/developer/building/intellij/debug3.jpg[]

Click on ‘Maven’.

image::/images/developer/building/intellij/debug4.jpg[]

Ensure that this configuration is the same as above. Click on Apply and OK.

image::/images/developer/building/intellij/debug5.jpg[]
