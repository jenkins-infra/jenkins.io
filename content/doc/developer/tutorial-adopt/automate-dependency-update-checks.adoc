...
:task-identifier: automate-dependency-checks
...
The GitHub `dependabot` tool can be configured to periodically to check for new releases of dependencies. When a new release is detected, dependabot submits a pull request to include that update in the plugin pom file. 
