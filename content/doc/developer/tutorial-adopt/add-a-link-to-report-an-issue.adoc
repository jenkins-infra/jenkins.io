...
:task-description: Add “Report an Issue”
...
+## Report an Issue
+
+Please report issues and enhancements through the [Jenkins issue tracker](https://www.jenkins.io/participate/report-issue/redirect/#19326).
+
----
