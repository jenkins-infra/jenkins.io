...
This guide is not needed for people, who want to translate plugins only and aren't plugin maintainers. Move on to link:../crowdin/[this document] if you want to learn more about using crowdin as a translator.
