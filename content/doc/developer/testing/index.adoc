...
==== Using a Git SCM
You can create a Git repository during a test using `@GitSampleRepoRule`. This can be found in the link:https://github.com/jenkinsci/git-plugin/blob/master/src/test/java/jenkins/plugins/git/GitSampleRepoRule.java[git-plugin].
