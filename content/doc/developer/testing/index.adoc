...
// TODO: verify link to blogpost
* link:https://jenkins.io/blog/2019/06/14/performance-testing-jenkins[Blog post on running benchmarks]
* link:https://github.com/jenkinsci/jenkins-test-harness/blob/master/docs/jmh-benchmarks.adoc[Creating Benchmarks]
* link:https://github.com/jenkinsci/configuration-as-code-plugin/blob/0314b7a6a896d8486cad3bab7305164e1fe81a5b/docs/benchmarks/jmh-benchmarks.md[Using Configuration As Code to setup benchmarks]
