...
This is especially problematic for users with extended read permissions (for example, `Jenkins.SYSTEM_READ` or `Item.EXTENDED_READ`), as it can make configuration pages unusable.
