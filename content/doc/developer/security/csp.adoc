...
Alternatively, you can switch from `f:submit` or a `button` to a link, which can be made look like a button: `<a class="jenkins-button">` (optionally other classes adding the correct primary/secondary/tertiary style).
