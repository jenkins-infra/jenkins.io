...
Please make sure that the Java JDK configured in VS Code matches the version required by the project (as defined by the build configuration, such as the project's pom.xml file).
