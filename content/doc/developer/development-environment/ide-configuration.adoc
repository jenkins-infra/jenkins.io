...
Please make sure that the Java JDK configured in VS Code matches a supported Jenkins version.
Refer to the link:/doc/book/platform-information/support-policy-java/[Jenkins Java support policy] and https://code.visualstudio.com/docs/java/java-project#_configure-runtime-for-projects[VS Code Java configuration documentation] for more details.
