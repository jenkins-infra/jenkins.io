...
==== Known Issue: Randomly occurring connection failures with password protected ed25519 SSH keys

link:https://issues.jenkins-ci.org/browse/JENKINS-46754[JENKINS-46754]

A regression involving authentication using password-protected ed25519 SSH keys has been identified in 2.73.
...
. Do not protect ed25519 SSH keys in Jenkins with a password
