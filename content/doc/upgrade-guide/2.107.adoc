...
* Many plugins require updates to be compatible with this new restriction
...
* If the affected plugins are not upgraded, they may fail to load or save data on disk, or fail to execute commands e.g. during a build.
* For a full list of issues related to JEP-200, see https://issues.jenkins-ci.org/issues/?jql=labels%20%3D%20JEP-200[the label JEP-200 in the issue tracker].

In order to help with upgrade,
JEP-200 maintainers have also created upgrade guidelines (link:https://www.google.com/url?q=https%3A%2F%2Fspeakerdeck.com%2Fonenashev%2Fjenkins-jep-200-status-update-and-heads-up&sa=D&sntz=1&usg=AFQjCNG2yWKrxw-jkqc-he9fd6bFa5675A[slides],
