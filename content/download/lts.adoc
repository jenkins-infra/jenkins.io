...
After switching between release lines, it's recommend to update the update site metadata cached in Jenkins by hitting the "Check Now" button in the Plugins Manager, or hitting this url: \http://<jenkins_base_URL>/pluginManager/checkUpdatesServer.
