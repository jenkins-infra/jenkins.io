...
Backporters use link:https://github.com/jenkinsci/jenkins/issues?q=state%3Aclosed%20label%3Alts-candidate[this query] to list up issues that need to be attended once resolved.
