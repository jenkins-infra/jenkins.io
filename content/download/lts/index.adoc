...
While almost all weekly releases more recent than the LTS baseline release will be compatible, important fixes that are in the LTS release, such as security fixes, may not be present in older weekly releases.
