...
The link:https://cd.foundation[Continuous Delivery Foundation (CDF)] serves as the vendor-neutral home of many of the fastest-growing projects for countinous integration/continuous delivery (CI/CD), including Jenkins, Jenkins X, Tekton, and Spinnaker,
as well as fosters collaboration between the industry’s top developers, end users and vendors to further CI/CD best practices and industry specifications.

Its mission is to grow and sustain projects that are part of the broad and growing continuous delivery ecosystem.
The Foundation believes in the power of Continuous Delivery to empower developers and teams to produce high quality software more rapidly and the open source solutions collectively addressing the whole software delivery lifecycle. It fosters and sustains the ecosystem of open-source, vendor neutral projects through collaborations and interoperability, advocates this idea and encourages collaborations among practitioners to share and improve their practices.
