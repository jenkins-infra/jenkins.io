...
world reliably build, test and deploy their software
""
...
image::/images/logo.png[title="Jenkins", width="128", float=right]
...
from link:http://mirrors.jenkins-ci.org/art/[here].
