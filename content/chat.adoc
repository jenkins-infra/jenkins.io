...
Use this channel if you are not sure where to ask, and other contriburos will help you.
...
There is an **unofficial** `#jenkins-ci` channel in the Kubernetes Slack.
