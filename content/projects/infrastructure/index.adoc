...
In case you need to add some of those services to your allow-list, you can find their public IP addresses at https://reports.jenkins.io/infrastructure/latest/index.json (updated hourly)
