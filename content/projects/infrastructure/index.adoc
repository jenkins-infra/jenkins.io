...
| https://updates.jenkins.io[Update Center]  | https://github.com/jenkins-infra/helpdesk/labels/update-center[GitHub issues]  | https://github.com/jenkins-infra/update-center2[Code], link:https://reports.jenkins.io/infrastructure/latest/index.json[IPv4 & IPv6 address list]
