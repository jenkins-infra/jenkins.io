...
- Java
- Docker
discussionTo: https://docs.google.com/document/d/1r_wOqtzmiIyiNWri6U3FKINWdnyHWEMF_lbSCa4jPiw/edit?usp=sharing
mentors:
- name: "Andrey Falko"
  github: "afalko"
...
we want to detect when it changes by polling. The source registry should not matter.
