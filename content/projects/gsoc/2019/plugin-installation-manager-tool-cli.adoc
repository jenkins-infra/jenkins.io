...
to be a challenging first step (see link:https://issue-redirect.jenkins.io/issue/57672[JENKINS-57672]).
...
* link:https://issue-redirect.jenkins.io/issue/58199?jql=project%20%3D%20JENKINS%20AND%20component%20%3D%20plugin-installation-manager-tool[Jira tasks and feature requests]
...
link:https://issue-redirect.jenkins.io/issue/58199?jql=project%20%3D%20JENKINS%20AND%20component%20%3D%20plugin-installation-manager-tool[Jira]
