...
by the time the <<ranking_and_slot_request_phase>> phase begins. It is possible for org admins to add mentors later, but that would be only
if an already registered mentor could no longer participate.

In the Jenkins organization, we have the concepts of lead mentor and co-mentors.

The lead mentor has the responsibilities of a co-mentor, and is also primarily responsible for the general administrative duties
commonly found in GSoC:
