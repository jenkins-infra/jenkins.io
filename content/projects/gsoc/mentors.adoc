...
* The mentor's watering hole is a the #gsoc-2022-jenkins channel on the CDF Slack (See link:https://www.jenkins.io/chat/#continuous-delivery-foundation[Continuous Delivery Foundation] for connection details.)
