...
==== Project Details
Leverage the Tekton command-line tool (tkn)[https://github.com/tektoncd/cli] to create a DSL which can be used in a groovy based Jenkinsfile to manage Tekton specific lifecycle.
