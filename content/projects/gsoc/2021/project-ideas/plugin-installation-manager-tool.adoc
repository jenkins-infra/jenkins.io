...
goal: "Introduce new features and improvements in the the plugin installation manager"
category: Tools
year: 2020
status: published
sig: platform
...
students are invited to introduce new features and improvements in the the plugin installation manager.
