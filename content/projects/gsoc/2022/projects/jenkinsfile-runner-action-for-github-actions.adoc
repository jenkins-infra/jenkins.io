...
* link:https://deploy-preview-5402--jenkins-io-site-pr.netlify.app/blog/2022/09/07/jenkinsfile-runner-as-github-actions/[A near Feature-complete version of Jenkinsfile Runner Actions as GitHub Actions]
