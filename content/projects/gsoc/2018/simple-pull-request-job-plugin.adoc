...
Internally, it converts the user written YAML file into Declarative [Pipeline DSL](https://jenkins.io/doc/book/pipeline/) code which is then executed by the declarative engine.
