...
* link:/projects/gsoc/2023/projects/gitlab-plugin-modernization[GitLab Plugin Modernization] with Harsh Pratap Singh as GSoC contributor.
* link:/projects/gsoc/2023/projects/add-probes-to-plugin-health-score[Add probes to \"Plugin Health Score\"] with Jagruti Tiwari as GSoC contributor.
* link:/projects/gsoc/2023/projects/alternative-jenkinsio-build-tool[Building Jenkins.io with alternative tools] with Vandit Singh as GSoC contributor.
* link:/projects/gsoc/2023/projects/docker-compose-build[Docker-based Jenkins quickstart examples] with Ashutosh Saxena as GSoC contributor.
