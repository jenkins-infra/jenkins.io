...
See our link:https://summerofcode.withgoogle.com/programs/2026/organizations/jenkins-wp[Jenkins organization page on the GSoC website].
...
// The project ideas for 2026 are:
//
// * link:/projects/gsoc/2026/project-ideas/ai-chatbot-to-guide-user-workflow[AI Chatbot to Guide User Workflow].
// * link:/projects/gsoc/2026/project-ideas/continue-ai-powered-chatbot-for-quick-access-to-jenkins-resources[Continue AI Powered Chatbot for Quick Access to Jenkins Resources].
// * link:/projects/gsoc/2026/project-ideas/continue-jenkins-docs-sites-retooling[Continue Jenkins Docs Sites Retooling].
// * link:/projects/gsoc/2026/project-ideas/jenkins-email-notifications-using-outlook-smtp-with-oath[Jenkins email notifications using Outlook SMTP with OAuth]
// * link:/projects/gsoc/2026/project-ideas/plugin-modernizer-stats-visualization[Plugin Modernizer Stats Visualization].
// * link:/projects/gsoc/2026/project-ideas/retool-jenkins-io-contributor-spotlight[Retool Jenkins.io Contributor Spotlight].
// * link:/projects/gsoc/2026/project-ideas/retool-jenkins-io-website-success-stories[Retool Jenkins.io Website Success Stories].
// * link:/projects/gsoc/2026/project-ideas/use-opentelemetry-for-jenkins-jobs-on-ci-jenkins-io[Use OpenTelemetry for Jenkins Jobs on ci.jenkins.io].

The five selected projects for 2026 are:

* link:/projects/gsoc/2026/projects/ai-chatbot-to-guide-user-workflow[AI Chatbot to Guide User Workflow] with link:https://github.com/thatsdc[Daniele Caldarigi] as the GSoC contributor.
* link:/projects/gsoc/2026/projects/continue-ai-powered-chatbot-for-quick-access-to-jenkins-resources[Continue AI-Powered Chatbot for Quick Access to Jenkins Resources] with link:https://github.com/arjun-713[Mallikarjun G D] as the GSoC contributor.
* link:/projects/gsoc/2026/projects/jenkins-email-notifications-using-outlook-smtp-with-oath[Jenkins email notifications using Outlook SMTP with OAuth] with link:https://github.com/Faheem12005[Mohammed Faheem] as the GSoC contributor.
* link:/projects/gsoc/2026/projects/plugin-modernizer-stats-visualization[Plugin Modernizer Stats Visualization] with link:https://github.com/pratikmane0112[Pratik Mane] as the GSoC contributor.
* link:/projects/gsoc/2026/projects/retool-jenkins-io-website-success-stories[Retool jenkins.io website Success Stories] with link:https://github.com/Vatsal-Verma[Vatsal Verma] as the GSoC contributor.

The original GSoC 2026 project ideas proposed and selected from link:./2026/project-ideas[this list].

// We have finalized a list of 11 project ideas, 8 of which are accepted ones.
...
* There is also a link:https://matrix.to/#/#jenkinsci_gsoc-sig:gitter.im[GSoC Matrix channel] for real-time communications, but it is better to use Discourse to request technical feedback or to have long-form discussions.
...
* link:https://matrix.to/#/#jenkinsci_gsoc-sig:gitter.im[GSoC Matrix channel] for organizational topics related to Jenkins in GSoC
...
* link:/blog/2026/02/19/jenkins-accepted-as-gsoc-2026-mentoring-org[Jenkins GSoC 2026 announcement]
...
== AI Usage Policy for Jenkins Contributions
We have a set of guidelines for GSoC contributors on the usage of AI. For details, see:

* link:/projects/gsoc/ai-usage-policy[GSoC AI Policy]
