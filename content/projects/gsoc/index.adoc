...
* link:/projects/gsoc/2026/project-ideas/use-opentelemetry-for-jenkins-jobs-on-ci_jenkins_io[Use OpenTelemetry for Jenkins Jobs on ci.jenkins.io].
...
We have a set of guidelines for GSoCcontributors on the usage of AI. For details see:
