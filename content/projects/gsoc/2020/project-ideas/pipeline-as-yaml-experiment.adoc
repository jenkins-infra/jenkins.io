...
YAML definitions are widely used in CI/CD systems, including JayeX, Tekton, and many popular CI/CD services (see below).
...
* New Pipeline syntax which is close to the link:https://jayex.io/v3/develop/pipelines/[JayeX Pipeline].
  It is not possible to provide full syntax compatibility between Jenkins and JayeX due to different use-cases,
...
* If you are familiar with Kubernetes, explore link:https://jayex.io[JayeX] and specifically link:https://jayex.io/v3/develop/pipelines/[JayeX Pipelines].
...
* link:https://jayex.io/v3/develop/pipelines/[JayeX Pipelines]
