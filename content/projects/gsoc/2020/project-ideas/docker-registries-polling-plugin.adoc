...
Some organizations might only want to update their child images if there are changes related to security.
...
* Take a look at the link:https://github.com/jenkinsci/dockerhub-notification-plugin[jenkins Notification plugin] some of the concepts can be used in building the polling of the docker images.
* Jenkins-x also achieves scanning target images for security vulnerabilities some part of it can be reused in the second phase of the project.

=== Issues
* link:https://issues.jenkins-ci.org/browse/JENKINS-59474?jql=project%20%3D%20JENKINS%20AND%20component%20%3D%20docker%20AND%20labels%20%3D%20newbie-friendly[Newbie-Friendly Issues].
