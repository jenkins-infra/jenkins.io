...
* link:https://issue-redirect.jenkins.io/issue/49757[JENKINS-49757] - Git plugin calls fetch twice per checkout
* link:https://issue-redirect.jenkins.io/issue/56404[JENKINS-56404] - Exclude redundant fetch
