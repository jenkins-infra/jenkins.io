...
* Remove a redundant fetch (link:https://issue-redirect.jenkins.io/issue/49757[JENKINS-49757]) during initial checkout (link:https://github.com/jenkinsci/git-plugin/pull/845[PR-845])
...
. Fix git redundant fetch issue link:https://issue-redirect.jenkins.io/issue/49757[JENKINS-49757]
