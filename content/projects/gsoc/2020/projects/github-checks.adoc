...
* Pipeline support to allow users publishing customized checks
* Rerun support on GitHub to allow users requesting a rebuild for failed builds
...
* link:/blog/2020/07/2020-07-09-github-checks-api-plugin-coding-phase-1.adoc[Blog post].
...
* link:/blog/2020/08/2020-08-03-github-checks-api-plugin-coding-phase-2.adoc[Blog post]
...
* Write link:https://github.com/jenkinsci/checks-api-plugin/blob/master/docs/consumers-guide.md[consumers guide] and link:https://github.com/jenkinsci/checks-api-plugin/pull/22[implementation guide]
* link:https://docs.google.com/presentation/d/1fMjXH0ANJ67x1R4sfQR5hkTXUmkhiZl-um71RTdXedA/edit?usp=sharing[Final presentation slide]
// TODO: Change the link to the doc after merged

=== Meeting
* We host 14 meetings during the whole GSoC 2020, you can find the details in the link:https://docs.google.com/document/d/1TZLmu3nBPbwUjzLVYGnV_YtYvmzxzw6A4eEVYpbmi3Y/edit?usp=sharing[meeting notes].