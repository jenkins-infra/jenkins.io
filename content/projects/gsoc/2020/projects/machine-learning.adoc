...
- Blog post 
** link:/content/blog/2020/06/machine-learning-plugin-community-bonding.adoc[Community Bonding summary]
...
* Blog post
** link:/content/blog/2020/06/machine-learning-plugin-coding-phase1.adoc[Coding Phase 1 summary]
