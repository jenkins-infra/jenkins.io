...
. Publish a summary of your status and the next steps, to the link:https://groups.google.com/forum/#!forum/jenkinsci-gsoc-all-public[Jenkins GSoC mailing list].
...
who successfully finish your projects.
