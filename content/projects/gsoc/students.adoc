...
. Setup the weekly meeting schedule with your mentors:
  ...
  * Announce your meeting schedule on the link:https://gitter.im/jenkinsci/gsoc-sig[Jenkins GSoC Gitter Chat].
...
. Continue to discuss and plan the project with the community and the mentors:
  ...
  *** Implementation plan with milestones per coding period.
...
. Become familiar with the link:https://issues.jenkins-ci.org/secure/Dashboard.jspa[Jenkins issue tracker] works (we use Jira)
 ...
 * Chat a line or two about what you are doing, every coding day, in your project channel (writing code, writing tests, updating documentation, etc.).
 ** Just saying "Hi, today I am working on these classes" or "writing tests for ..." is good enough, but you can of course interact more if you want.
 * You have timely community interactions when you need help (do not stay stuck without telling mentors).
 * If you are stuck, if you get lost in the code, if you are confused, say it.
...
At the end of each coding period, students are expected to do a public on-line presentation.
...
* _jenkinsci-gsoc-orgs@googlegroups.com_ - for **private** communications with org admins (escalations, issues with mentors)
