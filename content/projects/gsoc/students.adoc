...
. Check out the link:/projects/gsoc/2022/project-ideas[GSoC 2022 Project ideas]
...
. Join the link:https://community.jenkins.io[Discourse communication channel]  
...
. Any other section that the contributor deem is applicable and helps the proposal
...
NOTE: Please note that the link:https://community.jenkins.io[Discourse channel]
...
=== First begin a communication in Discourse via https://community.jenkins.io

* Please use the _[GSOC 2022 PROPOSAL] Your Name and Project Title_ subject in discussion.
 ...
 * It means 12 weeks of writing good code, about 30..40 hours per week is an **expected** workload though it can be adjusted upon the agreements with mentors.
