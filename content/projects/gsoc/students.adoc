...
. If you are an accepted students in the United States of America on an F1 visa, you must obtain an link:https://developers.google.com/open-source/gsoc/faq#i_am_an_accepted_student_in_the_united_states_on_an_f1_visa_how_do_i_get_authorization_to_participate[authorization before you can participate].
 ...
 * If you are stuck, lost in the code, confused, do say it.
 ...
 * Notify your mentors when you take time off.
...
. The presentation consists of Google Slides and a demo, on a Google Hangout.
