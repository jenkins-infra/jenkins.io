...
image:/images/logos/JCasC/JCasC.svg["Jenkins Configuration as Code", role=right, width=128]
...
image:/images/logos/kubernetes-operator/256.png["Jenkins Operator", role=left, width=128]
