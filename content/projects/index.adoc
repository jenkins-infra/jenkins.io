...
image:/images/gsod/gsod.png["Season of Docs", role=left, width=128]
...
image:/images/projects/jcasc/jcasc-logo.png["Jenkins Configuration as Code", role=left]
