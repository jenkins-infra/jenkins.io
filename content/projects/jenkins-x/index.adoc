...
The link:https://jenkins-x.io[Jenkins-X] documentation site has more details. Read a great introduction on the link:https://jenkins.io/blog/2018/04/10/opinionated-cd-jenkins-x/[blog].
