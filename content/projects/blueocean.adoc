...
To store your Jenkins data on the host simply replace `/your/home` in the following command with a path on your host and run `docker run -p 8080:8080 -p 50000:50000 -v /your/home:/var/jenkins_home jenkins`.

Or to use with a link:docker run --name myjenkins -p 8080:8080 -p 50000:50000 -v /var/jenkins_home jenkins[Docker Volume] run `docker run --name myjenkins -p 8080:8080 -p 50000:50000 -v /var/jenkins_home jenkins`.
