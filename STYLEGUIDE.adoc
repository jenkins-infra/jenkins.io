...
* For consecutive sections that are related to or build on each other, there
  ...
  and a reasonable "closing" or epilogue at the end, to provide continuity between the
  documents
...
* Prefer "for example" over "e.g." which can be more clear to non-native english
  readers
* Don't use underscored lists (bullets) in place of section headers. Section
