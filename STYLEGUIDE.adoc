...
Scripted Pipeline::: functionality defined as a fully-featured, turing-complete,
...
macro, with the language specified in order to ensure the code block has its
...
"UI" can mean a lot of different things, the CLI is a "UI", the Pipeline script
