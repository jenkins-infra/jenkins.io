...
* EVENT_NAME - The name of the event.  
  Note, this is not _subject_ of the event, but the _name_.
  If the event is location specific, include the location in the name. Example: "Seattle JAM", "Jenkins World 2017 - San Francisco."
