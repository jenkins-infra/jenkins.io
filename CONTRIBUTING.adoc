...
.. *Tutorials* - step-by-step guides that teach users relatively new to
   ...
   documentation]". The source for tutorials can be found link:/tree/master/content/doc/tutorials[here].
...
is recommended that you refer to the link:http://asciidoctor.org/docs/asciidoc-syntax-quick-reference[quick reference]
