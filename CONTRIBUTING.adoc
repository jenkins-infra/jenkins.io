...
. *Jenkins User Documentation* - for people who want to _use_ Jenkins's existing
  functionality and plugin features. Refer to the
...
* *User Handbook* - rich and in-depth documentation, separated into chapters
  ...
  "link:https://www.divio.com/en/blog/documentation/[What nobody tells you about
  documentation]" blog post, the content of the User Handbook is a combination
  of "How-to guides" and "Reference" material. Read more about
...
link:content/doc/book[`content/doc/book/`] directory and
...
These getting started guides can be placed in link:content/doc/[`content/doc/`]
in a directory that is most appropriate for the topic, and the directory should
contain the `.adoc` file for the Getting Started Guide, as well as any
supplementary images or other assets to accompany the guide.
