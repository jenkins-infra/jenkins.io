...
. Once the pull request is merged, submit a pull request to the
  ...
  The pull request will usually add to either the "NOn plugin rewrites" section or the "Developer documentation section, depending on the content of the redirected page +
[source]
----
