...
All changes to this repository are submitted via
link:https://help.github.com/articles/about-pull-requests/[pull requests] from a
link:https://guides.github.com/activities/forking/[fork of this repository]
to the `master` branch of this repository using the usual
link:https://help.github.com/articles/github-flow/[GitHub Flow] model.
This means all changes are pushed to a branch in a fork and are then
link:https://help.github.com/articles/creating-a-pull-request-from-a-fork/[submitted as a pull request].
Changes can be pushed to a fork via the GitHub website file editor or from a local clone.

=== Using GitHub to edit files

GitHub makes it easy to add, edit, or delete individual files via their website's
link:link:https://help.github.com/articles/editing-files-in-your-repository/[File Editor].
...
You'll save your changes in a local branch and <<building, build and review>> them locally.
