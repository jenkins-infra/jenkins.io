...
In this example bash would be the name of the language used. So this second quantity should be replaced with the name of the language used in the code snippet accordingly.
